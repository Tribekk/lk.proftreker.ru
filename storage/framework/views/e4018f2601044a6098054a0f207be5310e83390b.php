...
} elseif ($_instance->childHasBeenRendered('wW3O20v')) {
    $componentId = $_instance->getRenderedChildComponentId('wW3O20v');
    $componentTag = $_instance->getRenderedChildComponentTagName('wW3O20v');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wW3O20v');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('wW3O20v', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/employer/dashboard.blade.php ENDPATH**/ ?>