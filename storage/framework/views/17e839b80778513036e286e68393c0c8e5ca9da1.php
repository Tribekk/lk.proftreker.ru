...
} elseif ($_instance->childHasBeenRendered('2Rhc5NP')) {
    $componentId = $_instance->getRenderedChildComponentId('2Rhc5NP');
    $componentTag = $_instance->getRenderedChildComponentTagName('2Rhc5NP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2Rhc5NP');
} else {
    $response = \Livewire\Livewire::mount('employer.students.selection-results', ['row' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('2Rhc5NP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/employer/reports/_students/_table-body.blade.php ENDPATH**/ ?>