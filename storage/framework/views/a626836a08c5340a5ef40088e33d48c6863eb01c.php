                    ...
                    <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                        ...
                        <li class="nav-item mr-3">
                            <a class="nav-link mx-0" data-toggle="tab" href="#location-tab">
                                ...
                                <span class="nav-text font-size-lg"><?php echo e(__('Область поиска учеников')); ?></span>
                            </a>
                        </li>
                    ...
                    <div class="tab-pane show px-7" id="user-tab" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                 ...
                                 <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['id' => 'first_name','readonly' => true,'name' => 'first_name','required' => true,'title' => 'Имя ответственного','value' => ''.e($orgunit->user()->first_name).'']); ?>
<?php $component->withName('inputs.input-text-v'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?> 
                                 ...
                                 <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['id' => 'last_name','name' => 'last_name','required' => true,'title' => 'Фамилия ответственного','value' => ''.e($orgunit->user()->last_name).'','readonly' => 'true']); ?>
<?php $component->withName('inputs.input-text-v'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['disabled' => true]); ?>
...
<?php endif; ?> 
                                 ...
                                 <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['id' => 'middle_name','name' => 'middle_name','required' => true,'title' => 'Отчество ответственного','value' => ''.e($orgunit->user()->middle_name).'','readonly' => 'true']); ?>
<?php $component->withName('inputs.input-text-v'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['disabled' => true]); ?>
...
<?php endif; ?> 
                                 ...
                                 <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['name' => 'birth_date','id' => 'birth_date','readonly' => 'true','datePicker' => true,'placeholder' => 'дд.мм.гггг','title' => 'Дата рождения','required' => true,'value' => ''.e($orgunit->user()->birthDateFormatted).'']); ?>
<?php $component->withName('inputs.input-text-v'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['pattern' => '\d*','disabled' => true]); ?>
<?php if (isset($__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f)): ?>
<?php $component = $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f; ?>
<?php unset($__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f); ?>
<?php endif; ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['readonly' => true,'disabled' => true]); ?>
...
<?php endif; ?> 
                                 ...
                                 <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['title' => ''.e(__('Телефон ответственного')).'','type' => 'phone','value' => ''.e($orgunit->user()->phone).'','placeholder' => '+7 (___) ___ __ __','name' => 'phone','id' => 'phone','prependIcon' => 'la la-phone','required' => true,'readonly' => true]); ?>
<?php $component->withName('inputs.input-text-v'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <script>
                                   ...
                                   function get_classes(id,class_id=0) {
                                       ...
                                       if(school!="") {
                                           ...
                                           $.ajax({
                                               ...
                                               if (loaded.get('class_id_' + id) != check_str) {
                                                   ...
                                                   result.forEach(function (item) {
                                                       ...
                                                       if((item.number+item.letter)==class_id)
                                                           option.selected=true;
                               ...
                               <?php $__currentLoopData = $orgunit->search_location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php
                                    ...
                                    $schools_id=@$location_item["school_id"];
                                    $class_id=@$location_item["class_id"];

                                ?>

                                        <div id="main_div_location_<?php echo e($count_location); ?>" style="display:block">
                                 <?php if (isset($component)) { $__componentOriginala17b633d65f8f3e926f86950ce22a6bda77142d8 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Address::class, ['id' => 'search_location_'.e($count_location).'','name' => 'search_location_'.e($count_location).'','title' => 'Область поиска учеников №'.e($count_location).'','region' => ''.e($location).'','city' => ''.e($city).'','required' => 'true']); ?>
<?php $component->withName('inputs.address'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?> 
                                            ...
                                            <table><tr><td>Школа: </td><td width="5"></td><td>
                                            ...
                                            <br>
                                            <table><tr><td>Класс: </td><td width="5"></td><td>
                                                        <select name="class_id_<?php echo e($count_location); ?>" id="class_id_<?php echo e($count_location); ?>">
                                                        ...
                                                        <script>
                                                            ...
                                                            get_classes(<?php echo e($count_location); ?>,'<?php echo e($class_id); ?>');
                                                            },1000);
                                                        </script>
                                ...
                                <?php for($i=$count_location+1;$i<=$count_location+10;$i++): ?>
                                    ...
                                    <div id="main_div_location_<?php echo e($i); ?>" style="display:none">
                                         ...
                                         <?php if (isset($component)) { $__componentOriginala17b633d65f8f3e926f86950ce22a6bda77142d8 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Address::class, ['id' => 'search_location_'.e($i).'','city' => '','name' => 'search_location_'.e($i).'','title' => 'Область поиска учеников №'.e($i).'','required' => 'true']); ?>
<?php $component->withName('inputs.address'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?> 
                                        ...
                                        <br>
                                        <table><tr><td>Класс: </td><td width="5"></td><td>
                                                    <select name="class_id_<?php echo e($i); ?>" id="class_id_<?php echo e($i); ?>">
...
<?php endif; ?> 
                            ...
                            <h3>Добавление вопроса в опросник КВИЗ</h3>
                                ...
                                <div id="total_quiz_question_<?php echo e($i); ?>" style="width:1000px;<?php if($i<=$current_answers): ?> display: block; <?php else: ?>  display: none; <?php endif; ?>">
