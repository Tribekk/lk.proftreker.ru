...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('Hy7b2A3')) {
    $componentId = $_instance->getRenderedChildComponentId('Hy7b2A3');
    $componentTag = $_instance->getRenderedChildComponentTagName('Hy7b2A3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Hy7b2A3');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('Hy7b2A3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>        
                 ...
                 <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['name' => 'number','required' => true,'title' => 'Номер школы','value' => ''.e(old('number', $school->number)).'']); ?>
<?php $component->withName('inputs.input-text-v'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
} elseif ($_instance->childHasBeenRendered('20eHhLW')) {
    $componentId = $_instance->getRenderedChildComponentId('20eHhLW');
    $componentTag = $_instance->getRenderedChildComponentTagName('20eHhLW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('20eHhLW');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'type_of_educational_organization_id','id' => 'type_of_educational_organization','url' => ''.e(route('admin.types_of_educational_organization.view')).'','event' => 'setTypeEducationalOrganization','placeholder' => ''.e(__('Укажите вид образовательной организации')).'','selected' => ''.e(old('type_of_educational_organization_id', $school->type_of_educational_organization_id)).'','selectedItemUrl' => '/admin/types_of_educational_organization']);
    $html = $response->html();
    $_instance->logRenderedChild('20eHhLW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('components.select2', ['name' => 'loyalty_level_id','id' => 'loyalty_level','url' => ''.e(route('admin.loyalty_levels.view')).'','event' => 'setLoyaltyLevel','placeholder' => ''.e(__('Укажите уровень лояльности')).'','selected' => ''.e(old('loyalty_level_id', $school->loyalty_level_id)).'','selectedItemUrl' => '/admin/loyalty_levels'])->html();
} elseif ($_instance->childHasBeenRendered('C9RDHxe')) {
    $componentId = $_instance->getRenderedChildComponentId('C9RDHxe');
    $componentTag = $_instance->getRenderedChildComponentTagName('C9RDHxe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('C9RDHxe');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'loyalty_level_id','id' => 'loyalty_level','url' => ''.e(route('admin.loyalty_levels.view')).'','event' => 'setLoyaltyLevel','placeholder' => ''.e(__('Укажите уровень лояльности')).'','selected' => ''.e(old('loyalty_level_id', $school->loyalty_level_id)).'','selectedItemUrl' => '/admin/loyalty_levels']);
    $html = $response->html();
    $_instance->logRenderedChild('C9RDHxe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/admin/schools/_edit/_school-tab.blade.php ENDPATH**/ ?>