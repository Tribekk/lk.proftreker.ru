                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 d-md-block d-none">
                                <img src="<?php echo e(asset('img/green_bot.png')); ?>" style="transform: scaleX(-1)" alt="Учитель" class="img-fluid">
                            </div>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/user/type/attach-student.blade.php ENDPATH**/ ?>