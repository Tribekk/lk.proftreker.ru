...
<?php $__currentLoopData = $invites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="font-size-lg">
        <td class="fit">
            <?php echo e($invites->firstItem() + $index); ?>

        </td>

        <td>
            <a href="<?php echo e(route('events.invites.show', $item)); ?>" class="font-weight-bold link"><?php echo e($item->event->title); ?></a>
        </td>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/events/user/invites/_index/_table-body.blade.php ENDPATH**/ ?>