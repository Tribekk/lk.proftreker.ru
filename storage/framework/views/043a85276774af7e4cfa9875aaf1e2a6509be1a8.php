...
} elseif ($_instance->childHasBeenRendered('afQpo7u')) {
    $componentId = $_instance->getRenderedChildComponentId('afQpo7u');
    $componentTag = $_instance->getRenderedChildComponentTagName('afQpo7u');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('afQpo7u');
} else {
    $response = \Livewire\Livewire::mount('event.attached-files', ['event' => $event]);
    $html = $response->html();
    $_instance->logRenderedChild('afQpo7u', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/events/edit.blade.php ENDPATH**/ ?>