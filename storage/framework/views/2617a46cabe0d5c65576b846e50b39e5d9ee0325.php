...
<?php $component = $__env->getContainer()->make(App\View\Components\Subheader::class, ['title' => 'Управление списком аудитории']); ?>
            ...
            <div class="col">
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="<?php echo e(route('employer.events.audience.store')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/events/audience/create.blade.php ENDPATH**/ ?>