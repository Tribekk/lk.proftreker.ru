...
<?php $component = $__env->getContainer()->make(App\View\Components\Subheader::class, ['title' => 'Управление организацией']); ?>
                    ...
                    <div class="tab-pane show px-7 active" id="common-tab" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <form action="<?php echo e(route('orgunits.update', $orgunit)); ?>" enctype="multipart/form-data" method="post">
                                    <?php echo csrf_field(); ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['readonly' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('true'),'disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('true')]); ?>
<?php if (isset($__componentOriginala17b633d65f8f3e926f86950ce22a6bda77142d8)): ?>
<?php $component = $__componentOriginala17b633d65f8f3e926f86950ce22a6bda77142d8; ?>
<?php unset($__componentOriginala17b633d65f8f3e926f86950ce22a6bda77142d8); ?>
<?php endif; ?>
...
<?php endif; ?> 
                                ...
                                <?php if($count_location==0): ?>
                                     ...
                                     <?php if (isset($component)) { $__componentOriginala17b633d65f8f3e926f86950ce22a6bda77142d8 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Address::class, ['id' => 'search_location_1','city' => '','name' => 'search_location_1','title' => 'Область поиска учеников','required' => 'true']); ?>
<?php $component->withName('inputs.address'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?> 
                                ...
                                <h3>Хотите изменить области поиска, удалить ли добавить какую-то область?<br>
                    ...
                    <div class="tab-pane show px-7" id="profiles-tab" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <?php $__currentLoopData = $orgunit->activityKindIdsArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user_profile_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $user_profile=\Domain\UserProfile\Models\UserProfile::find($user_profile_id);
                                    ?>

                                    <?php if($user_profile): ?>
                                        <div style="border:1px solid orangered;border-radius:3px;padding:5px;width:300px" align="center"><?php echo e($user_profile->title); ?></div><br>
...
<?php endif; ?> 
                                ...
                                <table><tr><td valign="top" style="padding:5px">
                                            ...
                                            <br>
                                            <textarea name="ftp_access" style="width:350px;height:250px" readonly><?php echo e($orgunit->ftp_access); ?></textarea>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>    <?php if (isset($component)) { $__componentOriginal08b461424c1656985c58a1aeedb49491fde44a5f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\ButtonLink::class, ['type' => 'btn-outline-success','target' => '_blank','link' => ''.e($orgunit->landing_address).'','title' => ''.e(__('Просмотр лендинга')).'']); ?>
<?php $component->withName('inputs.button-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/proftracker/resources/views/orgunits/edit.blade.php ENDPATH**/ ?>