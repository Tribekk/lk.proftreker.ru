...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('kbGflJd')) {
    $componentId = $_instance->getRenderedChildComponentId('kbGflJd');
    $componentTag = $_instance->getRenderedChildComponentTagName('kbGflJd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kbGflJd');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('kbGflJd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
<?php /**PATH /var/www/proftracker/resources/views/results/_student-questionnaire/_search.blade.php ENDPATH**/ ?>