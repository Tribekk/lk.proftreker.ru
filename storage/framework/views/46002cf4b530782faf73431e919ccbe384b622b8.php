...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('PyvIntX')) {
    $componentId = $_instance->getRenderedChildComponentId('PyvIntX');
    $componentTag = $_instance->getRenderedChildComponentTagName('PyvIntX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PyvIntX');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('PyvIntX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('EPCcf9q')) {
    $componentId = $_instance->getRenderedChildComponentId('EPCcf9q');
    $componentTag = $_instance->getRenderedChildComponentTagName('EPCcf9q');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EPCcf9q');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e($user->school_id).'','classId' => ''.e($user->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('EPCcf9q', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('6494zNl')) {
    $componentId = $_instance->getRenderedChildComponentId('6494zNl');
    $componentTag = $_instance->getRenderedChildComponentTagName('6494zNl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6494zNl');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('6494zNl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
