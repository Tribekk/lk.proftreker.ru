...
} elseif ($_instance->childHasBeenRendered('l2618682385-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2618682385-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2618682385-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2618682385-0');
} else {
    $response = \Livewire\Livewire::mount('quiz.suitable-professions', ['availableQuiz' => $availableQuiz]);
    $html = $response->html();
    $_instance->logRenderedChild('l2618682385-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php else: ?>
        <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($question->isRequiredQuestion(Auth::id())): ?>
                ...
                <div class="w-100 border shadow-sm mb-10 font-size-h3 p-10">
                    <div class="mb-5">
                        ...
                        <?php if($question->description): ?>
                            <p class="text-dark-50 small font-size-h4"><?php echo e($question->description); ?></p>
                        <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/livewire/quiz/run-quiz.blade.php ENDPATH**/ ?>