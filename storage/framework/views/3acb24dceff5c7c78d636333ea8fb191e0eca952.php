...
<?php endif; ?>
    ...
    or $item->type()->first()->code=="yn"
        ...
        <?php $__currentLoopData = $item->answers()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <input type="radio" id="radio_<?php echo e($anketItems->first()->id); ?>_<?php echo e($answer->id); ?>" name="anketItems[<?php echo e($type); ?>][<?php echo e($answer->id); ?>]" value="1"
...
<?php endif; ?><?php /**PATH /var/www/proftracker/resources/views/admin/user_profiles/include/anket_items_question_form.blade.php ENDPATH**/ ?>