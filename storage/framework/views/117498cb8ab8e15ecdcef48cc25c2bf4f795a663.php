...
} elseif ($_instance->childHasBeenRendered('xUv563I')) {
    $componentId = $_instance->getRenderedChildComponentId('xUv563I');
    $componentTag = $_instance->getRenderedChildComponentTagName('xUv563I');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xUv563I');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['nullableClassId' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('xUv563I', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('scRGvHN')) {
    $componentId = $_instance->getRenderedChildComponentId('scRGvHN');
    $componentTag = $_instance->getRenderedChildComponentTagName('scRGvHN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('scRGvHN');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('scRGvHN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/admin/users/_create/_user-tab.blade.php ENDPATH**/ ?>