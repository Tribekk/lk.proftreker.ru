<select class="form-control form-control-solid h-auto py-4 px-6 rounded-lg"
    ...
    <?php $__currentLoopData = $question->answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($answer->value ?? $answer->title); ?>" <?php if($answer->madeByUser(Auth::id())): ?> selected <?php endif; ?>><?php echo e($answer->title); ?></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</select>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/quiz/_run-quiz/_question-select.blade.php ENDPATH**/ ?>