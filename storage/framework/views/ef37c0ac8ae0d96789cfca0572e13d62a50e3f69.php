...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('6jtBPYt')) {
    $componentId = $_instance->getRenderedChildComponentId('6jtBPYt');
    $componentTag = $_instance->getRenderedChildComponentTagName('6jtBPYt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6jtBPYt');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('6jtBPYt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
