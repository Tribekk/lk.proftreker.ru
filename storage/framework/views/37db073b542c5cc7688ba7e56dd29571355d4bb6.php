...
<?php $component = $__env->getContainer()->make(App\View\Components\Subheader::class, ['title' => 'Мои мероприятия']); ?>
...
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
             <?php $__env->slot('title'); ?> <?php echo e($event->event->title); ?> <?php $__env->endSlot(); ?>
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="my-3 col-md-4">
                            ...
                            <div class="font-size-h6"><?php echo e($event->event->orgunit->title); ?></div>
                        </div>

                        <div class="my-3 col-md-4">
                            <div class="font-weight-bold font-size-h5">Формат проведения</div>
                            <div class="font-size-h6"><?php echo e($event->event->format->title); ?></div>
                        </div>

                        <div class="my-3 col-md-4">
                            <div class="font-weight-bold font-size-h5">Направление</div>
                            <?php $__currentLoopData = $event->event->directions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $direction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row">
                        <div class="my-3 col-md-4">
                            ...
                            <div class="font-size-h6 mt-2 <?php echo e($event->eventState->color()); ?>"><?php echo e($event->eventState->title()); ?></div>
                        </div>

                        <div class="my-3 col-md-4">
                            <div class="font-weight-bold font-size-h5">Время начала</div>
                            <div class="font-size-h6 mt-2"><?php echo e($event->event->start_at->format('d.m.Y H:i')); ?></div>
                        </div>

                        <div class="my-3 col-md-4">
                            <div class="font-weight-bold font-size-h5">Время завершения</div>
                            <div class="font-size-h6 mt-2"><?php echo e($event->event->finish_at->format('d.m.Y H:i')); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="my-3">
                        ...
                        <div class="button-group mt-2">
                            <?php $__currentLoopData = $event->event->audience; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($event->event->location): ?>
                        <div class="my-3 mt-6">
                            ...
                            <div class="font-size-h6"><?php echo e($event->event->location); ?></div>
                        </div>
                    <?php endif; ?>

                    <?php if($event->event->program): ?>
                        <div class="my-3 mt-6">
                            <div class="font-weight-bold font-size-h5">Программа мероприятия</div>
                            <div class=""><?php echo $event->event->program; ?></div>
                        </div>
                    <?php endif; ?>

                    <?php if($event->event->attachedFiles): ?>
                        <div class="my-3 mt-6">
                            <div class="font-weight-bold font-size-h5">Прикрепленные файлы</div>
                            <div class="mt-3">
                                <?php $__currentLoopData = $event->event->attachedFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\ButtonLink::class, ['title' => 'Вернуться назад','type' => 'btn-outline-success','link' => ''.e(route('events.view')).'']); ?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\openserver\OpenServer\domains\prof\www\resources\views/events/user/show.blade.php ENDPATH**/ ?>