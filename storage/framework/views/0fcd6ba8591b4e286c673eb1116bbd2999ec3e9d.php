...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('consultant.meeting_schedule.update', $appointment)); ?>" method="post">
                    <?php echo csrf_field(); ?>

                     <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['title' => 'Выберите день','required' => true,'placeholder' => 'Дата','value' => $appointment->date_at,'datePicker' => true,'name' => 'date_at','id' => 'date_at']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Select::class, ['title' => 'Выберите временной промежуток (по уральскому времени)','required' => true,'currentValue' => $appointment->time_interval_id,'values' => $timeIntervals,'name' => 'time_interval_id','id' => 'time_interval_id']); ?>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/consultant/meeting-schedule/update.blade.php ENDPATH**/ ?>