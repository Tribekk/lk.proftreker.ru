...
} elseif ($_instance->childHasBeenRendered('66mZZWJ')) {
    $componentId = $_instance->getRenderedChildComponentId('66mZZWJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('66mZZWJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('66mZZWJ');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('66mZZWJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
