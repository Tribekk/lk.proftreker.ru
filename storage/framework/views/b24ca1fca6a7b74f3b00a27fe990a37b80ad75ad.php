...
} elseif ($_instance->childHasBeenRendered('fDZsGvg')) {
    $componentId = $_instance->getRenderedChildComponentId('fDZsGvg');
    $componentTag = $_instance->getRenderedChildComponentTagName('fDZsGvg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fDZsGvg');
} else {
    $response = \Livewire\Livewire::mount('users.account', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('fDZsGvg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
