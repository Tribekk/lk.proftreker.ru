...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('qGVgEbH')) {
    $componentId = $_instance->getRenderedChildComponentId('qGVgEbH');
    $componentTag = $_instance->getRenderedChildComponentTagName('qGVgEbH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qGVgEbH');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('qGVgEbH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/components/inputs/select2.blade.php ENDPATH**/ ?>