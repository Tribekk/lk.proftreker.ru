            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title font-weight-bold font-size-h3 font-hero-super">
                        Редактирование критериев отбора (базовый тест) профиля "<?php echo e($userProfile->title); ?>"
                    </div>
                </div>
                <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#38957B">
                                                                ...
                                                                <?php echo $__env->make('admin.user_profiles.include.base_test_results_tipag_extended', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                Результат по матрице<br> профессий<br> (выбор профессии)
                                                            </td>
                                                            <td style="background-color:#38957B">
                                                                <?php
                                                                    $type="green"
                                                                ...
                                                                <?php echo $__env->make('admin.user_profiles.include.base_test_results_alt_component', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/admin/user_profiles/base_test_items.blade.php ENDPATH**/ ?>