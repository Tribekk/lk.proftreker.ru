...
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select2::class, ['id' => 'role_id','name' => 'role_id','classes' => 'col-md-4 col-lg-3','label' => ''.e(__('Роль')).'','placeholder' => ''.e(__('Роль пользователя')).'','event' => 'filterByRole','indexUrl' => ''.e(route('admin.roles.view')).'','showUrl' => '/admin/authorization/roles','value' => ''.e(request()->role_id).'']); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/admin/reports/_registrations/_search.blade.php ENDPATH**/ ?>