...
} elseif ($_instance->childHasBeenRendered('dbnF5dp')) {
    $componentId = $_instance->getRenderedChildComponentId('dbnF5dp');
    $componentTag = $_instance->getRenderedChildComponentTagName('dbnF5dp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dbnF5dp');
} else {
    $response = \Livewire\Livewire::mount('users.account', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('dbnF5dp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/admin/users/_edit/_user-tab.blade.php ENDPATH**/ ?>