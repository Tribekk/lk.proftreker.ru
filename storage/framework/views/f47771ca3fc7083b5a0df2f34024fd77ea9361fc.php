...
} elseif ($_instance->childHasBeenRendered('zF3tXSi')) {
    $componentId = $_instance->getRenderedChildComponentId('zF3tXSi');
    $componentTag = $_instance->getRenderedChildComponentTagName('zF3tXSi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zF3tXSi');
} else {
    $response = \Livewire\Livewire::mount('event.attached-files', ['event' => $event]);
    $html = $response->html();
    $_instance->logRenderedChild('zF3tXSi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/events/edit.blade.php ENDPATH**/ ?>