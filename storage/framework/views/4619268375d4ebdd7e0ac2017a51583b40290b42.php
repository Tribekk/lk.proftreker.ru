...
} elseif ($_instance->childHasBeenRendered('FMC2pN0')) {
    $componentId = $_instance->getRenderedChildComponentId('FMC2pN0');
    $componentTag = $_instance->getRenderedChildComponentTagName('FMC2pN0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FMC2pN0');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['nullableClassId' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('FMC2pN0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('6BG57Kg')) {
    $componentId = $_instance->getRenderedChildComponentId('6BG57Kg');
    $componentTag = $_instance->getRenderedChildComponentTagName('6BG57Kg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6BG57Kg');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('6BG57Kg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/proftracker/resources/views/admin/users/_create/_user-tab.blade.php ENDPATH**/ ?>