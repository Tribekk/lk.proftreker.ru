...
} elseif ($_instance->childHasBeenRendered('qFFsctm')) {
    $componentId = $_instance->getRenderedChildComponentId('qFFsctm');
    $componentTag = $_instance->getRenderedChildComponentTagName('qFFsctm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qFFsctm');
} else {
    $response = \Livewire\Livewire::mount('school.class-container', ['school' => $school]);
    $html = $response->html();
    $_instance->logRenderedChild('qFFsctm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
} elseif ($_instance->childHasBeenRendered('32tuB3M')) {
    $componentId = $_instance->getRenderedChildComponentId('32tuB3M');
    $componentTag = $_instance->getRenderedChildComponentTagName('32tuB3M');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('32tuB3M');
} else {
    $response = \Livewire\Livewire::mount('school.card', ['school' => $school]);
    $html = $response->html();
    $_instance->logRenderedChild('32tuB3M', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/school/card.blade.php ENDPATH**/ ?>