...
} elseif ($_instance->childHasBeenRendered('OZ7bfJY')) {
    $componentId = $_instance->getRenderedChildComponentId('OZ7bfJY');
    $componentTag = $_instance->getRenderedChildComponentTagName('OZ7bfJY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OZ7bfJY');
} else {
    $response = \Livewire\Livewire::mount('user.profile.unread-notifications-count', []);
    $html = $response->html();
    $_instance->logRenderedChild('OZ7bfJY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </span>
