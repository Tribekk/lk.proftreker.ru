...
<?php $component = $__env->getContainer()->make(App\View\Components\Subheader::class, ['title' => 'Отчет по базе учеников']); ?>
...
} elseif ($_instance->childHasBeenRendered('6hFqP3y')) {
    $componentId = $_instance->getRenderedChildComponentId('6hFqP3y');
    $componentTag = $_instance->getRenderedChildComponentTagName('6hFqP3y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6hFqP3y');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('6hFqP3y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/employer/reports/students.blade.php ENDPATH**/ ?>