...
} elseif ($_instance->childHasBeenRendered('54oOlpM')) {
    $componentId = $_instance->getRenderedChildComponentId('54oOlpM');
    $componentTag = $_instance->getRenderedChildComponentTagName('54oOlpM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('54oOlpM');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('54oOlpM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/proftracker/resources/views/employer/reports/students.blade.php ENDPATH**/ ?>