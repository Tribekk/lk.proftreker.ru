<div class="card-body">
    <div class="container">
        <h3 class="font-pixel text-dark-50 font-size-lg mb-40 text-center">Отчет <?php echo e($depthTestsFinished ? 'полного ' : 'базового'); ?> профориентационного тестирования</h3>

        <div class="row justify-content-center text-center text-md-left align-items-end align-items-md-start">
            <div class="<?php echo e($depthTestsFinished ? 'col-lg-4' : ''); ?> col-md-6">
                <div class="d-flex justify-content-md-start justify-content-center">
                    <div class="text-center <?php echo e($depthTestsFinished ? 'w-100' : 'w-50'); ?>">
            ...
            <div class="<?php echo e($depthTestsFinished ? 'col-lg-4 text-lg-center' : ''); ?> col-md-6 text-md-right">
                <div class="d-flex justify-content-md-end justify-content-center">
                    <div class="text-center <?php echo e($depthTestsFinished ? 'w-100' : 'w-50'); ?>">
                        ...
                        <?php endif; ?>
                        <span class="font-size-h3 font-hero mb-12 bg-orange p-5 text-center border-radius rounded-pill d-block text-white">Тест &laquo;Образ Я&raquo;</span>
                    </div>
                </div>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/quiz/_results/quizzes-screen.blade.php ENDPATH**/ ?>