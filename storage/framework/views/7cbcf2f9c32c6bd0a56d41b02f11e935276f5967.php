<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="text-dark font-size-h3 mb-5 mb-md-0"><?php echo $questionnaire->quiz->caption; ?></div>
        </div>
        <div class="col-md-4 align-self-center">
            <?php if($questionnaire->state->fillable()): ?>
...
<?php /**PATH /var/www/proftracker/resources/views/student/_dashboard/base-test-dashboard.blade.php ENDPATH**/ ?>