...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('rG20WVE')) {
    $componentId = $_instance->getRenderedChildComponentId('rG20WVE');
    $componentTag = $_instance->getRenderedChildComponentTagName('rG20WVE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rG20WVE');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('rG20WVE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/components/tables/filter-inputs/select2.blade.php ENDPATH**/ ?>