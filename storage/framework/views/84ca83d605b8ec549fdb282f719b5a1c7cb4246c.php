...
} elseif ($_instance->childHasBeenRendered('XL1l6KY')) {
    $componentId = $_instance->getRenderedChildComponentId('XL1l6KY');
    $componentTag = $_instance->getRenderedChildComponentTagName('XL1l6KY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XL1l6KY');
} else {
    $response = \Livewire\Livewire::mount('employer.students.selection-results', ['row' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('XL1l6KY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/employer/reports/_students/_table-body.blade.php ENDPATH**/ ?>