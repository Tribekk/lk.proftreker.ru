...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('VRtNpJj')) {
    $componentId = $_instance->getRenderedChildComponentId('VRtNpJj');
    $componentTag = $_instance->getRenderedChildComponentTagName('VRtNpJj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VRtNpJj');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('VRtNpJj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>

<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/components/inputs/address.blade.php ENDPATH**/ ?>