...
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select::class, ['id' => 'format_id','name' => 'format_id','classes' => 'col-md-4','label' => ''.e(__('Формат')).'','items' => $formats,'value' => ''.e(request()->format_id).'']); ?>
...
<?php endif; ?> 
 ...
 <?php if (isset($component)) { $__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select::class, ['id' => 'event_state','name' => 'event_state','classes' => 'col-md-4','label' => ''.e(__('Статус мероприятия')).'','items' => $eventStates,'value' => ''.e(request()->event_state).'']); ?>
<?php $component->withName('tables.filter-inputs.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?> <?php if (isset($__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b)): ?>
...
<?php endif; ?> 
 ...
 <?php if (isset($component)) { $__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select::class, ['id' => 'state','name' => 'state','classes' => 'col-md-4','label' => ''.e(__('Статус приглашения')).'','items' => $states,'value' => ''.e(request()->state).'']); ?>
<?php $component->withName('tables.filter-inputs.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?> <?php if (isset($__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b)): ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/events/user/invites/_index/_search.blade.php ENDPATH**/ ?>