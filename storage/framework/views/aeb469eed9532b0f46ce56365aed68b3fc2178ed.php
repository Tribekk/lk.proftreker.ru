...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('OZzi2rY')) {
    $componentId = $_instance->getRenderedChildComponentId('OZzi2rY');
    $componentTag = $_instance->getRenderedChildComponentTagName('OZzi2rY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OZzi2rY');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('OZzi2rY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/admin/reports/_students/_search.blade.php ENDPATH**/ ?>