...
} elseif ($_instance->childHasBeenRendered('L1DSVRi')) {
    $componentId = $_instance->getRenderedChildComponentId('L1DSVRi');
    $componentTag = $_instance->getRenderedChildComponentTagName('L1DSVRi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('L1DSVRi');
} else {
    $response = \Livewire\Livewire::mount('users.account', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('L1DSVRi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
