...
<div class="mt-5">
    <?php $__empty_1 = true; $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <button wire:click.prevent="$emit('revoke-permission', <?php echo e($permission['id']); ?>)" class="btn btn-outline-primary mr-3 mb-3">
            <i class="la la-times"></i><?php echo e($permission['title']); ?>

            <input type="text" hidden name="permissions[<?php echo e($loop->index); ?>][id]" value="<?php echo e($permission['id']); ?>">
            <input type="text" hidden name="permissions[<?php echo e($loop->index); ?>][title]" value="<?php echo e($permission['title']); ?>">
        </button>
...
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/admin/users/_create/_user-permissions.blade.php ENDPATH**/ ?>