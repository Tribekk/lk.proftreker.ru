<div>
    <form wire:submit.prevent="updateUser">
        <div class="pb-13 pt-lg-0 pt-5">
            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg"><?php echo e(__('Мои данные')); ?></h3>
        </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l3146512722-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3146512722-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3146512722-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3146512722-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l3146512722-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3146512722-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3146512722-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3146512722-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3146512722-1');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e(Auth::user()->school_id).'','classId' => ''.e(Auth::user()->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('l3146512722-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/livewire/user/profile/account.blade.php ENDPATH**/ ?>