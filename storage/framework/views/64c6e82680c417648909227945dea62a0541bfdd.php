...
} elseif ($_instance->childHasBeenRendered('nFcHdOt')) {
    $componentId = $_instance->getRenderedChildComponentId('nFcHdOt');
    $componentTag = $_instance->getRenderedChildComponentTagName('nFcHdOt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nFcHdOt');
} else {
    $response = \Livewire\Livewire::mount('quiz.suitable-professions', ['availableQuiz' => $availableQuiz]);
    $html = $response->html();
    $_instance->logRenderedChild('nFcHdOt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/proftracker/resources/views/livewire/quiz/run-quiz.blade.php ENDPATH**/ ?>