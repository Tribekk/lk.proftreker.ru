...
} elseif ($_instance->childHasBeenRendered('BjTYnuc')) {
    $componentId = $_instance->getRenderedChildComponentId('BjTYnuc');
    $componentTag = $_instance->getRenderedChildComponentTagName('BjTYnuc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BjTYnuc');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('BjTYnuc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/employer/reports/students.blade.php ENDPATH**/ ?>