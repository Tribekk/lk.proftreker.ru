...
} elseif ($_instance->childHasBeenRendered('l218322608-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l218322608-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l218322608-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l218322608-0');
} else {
    $response = \Livewire\Livewire::mount('quiz.suitable-professions', ['availableQuiz' => $availableQuiz]);
    $html = $response->html();
    $_instance->logRenderedChild('l218322608-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/livewire/quiz/run-quiz.blade.php ENDPATH**/ ?>