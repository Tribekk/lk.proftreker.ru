...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('oDrpHki')) {
    $componentId = $_instance->getRenderedChildComponentId('oDrpHki');
    $componentTag = $_instance->getRenderedChildComponentTagName('oDrpHki');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oDrpHki');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('oDrpHki', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/user/type/_employer-form.blade.php ENDPATH**/ ?>