...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('ragdXMs')) {
    $componentId = $_instance->getRenderedChildComponentId('ragdXMs');
    $componentTag = $_instance->getRenderedChildComponentTagName('ragdXMs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ragdXMs');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('ragdXMs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/proftracker/resources/views/employer/students/list/_list/_search.blade.php ENDPATH**/ ?>