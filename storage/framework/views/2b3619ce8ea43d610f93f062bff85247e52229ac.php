    ...
    <div class="content">
        ...
        <div style="display: inline-block; width: 700px; float: right;">
            <div style="width: 380px; margin-right: 20px; display: inline-block; vertical-align: top; white-space: pre-line;">
                ...
                <div class="font-size-h5 text-dark" style="word-wrap: break-word;"><?php echo e($questionnaireResult->suitsMeBetter); ?></div>

                <div class="mt-5">
                    <h3 class="font-weight-bold text-blue font-size-h4 mb-2">Мое идеально будущее</h3>
                    <?php $__currentLoopData = $questionnaireResult->perfectFuture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="font-size-h5 mb-2" style="word-wrap: break-word;"><?php echo e($value); ?></div>
                ...
                <div class="mt-5">
                    ...
                    <div class="font-size-h5 text-dark" style="word-wrap: break-word;"><?php echo e($questionnaireResult->concludingContractTargetedTraining); ?></div>
                </div>

                <div class="mt-5">
                    <h3 class="font-weight-bold text-blue font-size-h3 mb-2">Вероятность, что я останусь в родном городе</h3>
                    <div class="mt-5">
                        <div class="font-weight-bold font-size-h5 text-center text-blue mb-2"><?php echo e($questionnaireResult->chancesOfStayingHometown['value']); ?></div>
                        <div class="progress mb-4 bg-transparent my-3" style="position: relative; width: 100%; height: 18px">
                            <div class="progress-bar bg-blue" role="progressbar" style="width: <?php echo e($questionnaireResult->chancesOfStayingHometown['progress']); ?>%; z-index: 2;"></div>
            ...
            <div style="width: 270px; display: inline-block; vertical-align: top; float: right; white-space: pre-line;">
                ...
                <div class="font-size-h5 my-2" style="word-wrap: break-word;">
                    <?php echo e($questionnaireResult->chosenExams); ?>
                ...
                <div class="mt-5">
                    ...
                    <div class="font-size-h5 text-dark" style="word-wrap: break-word;"><?php echo e($questionnaireResult->receiveOffersFromTheEmployer); ?></div>
                </div>

                <div class="mt-5">
                    <h3 class="font-weight-bold text-primary font-size-h4">На текущий момент проявлена</h3>
                    <div class="font-size-h5 text-dark" style="word-wrap: break-word;"><?php echo e($questionnaireResult->willingness_to_choose_profession_label); ?></div>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/quiz/_results/_pdf/questionnaire-screen__willingness-to-choice.blade.php ENDPATH**/ ?>