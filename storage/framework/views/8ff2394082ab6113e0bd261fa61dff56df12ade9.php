                                            ...
                                            <tr>
                                                <td width="200">
                                                    ...
                                                    <?php endif; ?>
                                                        ...
                                                        <?php else: ?>
                                                            <a href="<?php echo e(route('user_profiles.base_test_items',$userProfile->id)); ?>"><button type="button" class="btn-outline-success" style="border-radius: 5px 5px 5px 5px; width:300px;height:40px;margin-top:5px;background-color:blue;color:white"><?php echo e(__('Базовый тест')); ?></button></a><br>
                                                        ...
                                                        <?php else: ?>
                                                            <a href="<?php echo e(route('user_profiles.deep_test_items',$userProfile->id)); ?>"><button type="button" class="btn-outline-success" style="border-radius: 5px 5px 5px 5px; width:300px;height:40px;margin-top:5px;background-color:blue;color:white"><?php echo e(__('Углубленный тест')); ?></button></a><br>
                                                        ...
                                                        <?php else: ?>
                                                            <a href="<?php echo e(route('user_profiles.anket_results',$userProfile->id)); ?>"><button type="button" class="btn-outline-success" style="border-radius: 5px 5px 5px 5px; width:300px;height:40px;margin-top:5px;background-color:blue;color:white"><?php echo e(__('Отбор по базовому тесту и анкете')); ?></button></a><br>
                                                        ...
                                                        <?php else: ?>
                                                            <a href="<?php echo e(route('user_profiles.deep_test_results',$userProfile->id)); ?>"><button type="button" class="btn-outline-success" style="border-radius: 5px 5px 5px 5px; width:300px;height:40px;margin-top:5px;background-color:blue;color:white"><?php echo e(__('Отбор по углубленному тесту')); ?></button></a><br>
                                                        ...
                                                        <?php else: ?>
                                                            <a href="<?php echo e(route('user_profiles.consult_results',$userProfile->id)); ?>"><button type="button" class="btn-outline-success" style="border-radius: 5px 5px 5px 5px; width:300px;height:40px;margin-top:5px;background-color:blue;color:white"><?php echo e(__('Отбор после карьерной консультации')); ?></button></a><br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\openserver\OpenServer\domains\prof\www\resources\views/admin/user_profiles/edit.blade.php ENDPATH**/ ?>