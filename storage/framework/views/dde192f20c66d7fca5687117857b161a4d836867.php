...
} elseif ($_instance->childHasBeenRendered('l1537978474-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1537978474-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1537978474-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1537978474-0');
} else {
    $response = \Livewire\Livewire::mount('quiz.suitable-professions', ['availableQuiz' => $availableQuiz]);
    $html = $response->html();
    $_instance->logRenderedChild('l1537978474-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/livewire/quiz/run-quiz.blade.php ENDPATH**/ ?>