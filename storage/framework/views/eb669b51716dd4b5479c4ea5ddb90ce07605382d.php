...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l2609676374-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2609676374-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2609676374-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2609676374-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l2609676374-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l2609676374-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2609676374-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2609676374-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2609676374-1');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e($user->school_id).'','classId' => ''.e($user->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('l2609676374-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l2609676374-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2609676374-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2609676374-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2609676374-2');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l2609676374-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/livewire/users/account.blade.php ENDPATH**/ ?>