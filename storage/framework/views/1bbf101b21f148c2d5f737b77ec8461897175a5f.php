...
} elseif ($_instance->childHasBeenRendered('y6gYCbp')) {
    $componentId = $_instance->getRenderedChildComponentId('y6gYCbp');
    $componentTag = $_instance->getRenderedChildComponentTagName('y6gYCbp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('y6gYCbp');
} else {
    $response = \Livewire\Livewire::mount('users.account', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('y6gYCbp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH /var/www/proftracker/resources/views/admin/users/_edit/_user-tab.blade.php ENDPATH**/ ?>