<div class="card card-custom">
    ...
    <div class="card-body">
        ...
        <p><b>Номер школы:</b> <?php echo e($school->number); ?></p>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <span class="text-muted">На данный момент классы отсутствуют<?php echo e(Auth::user()->hasRole('teacher') ? " или вы не являетесь руководителем класса(ов)" : ''); ?>.</span>
        <?php endif; ?>
    </div>
</div>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/livewire/school/card.blade.php ENDPATH**/ ?>