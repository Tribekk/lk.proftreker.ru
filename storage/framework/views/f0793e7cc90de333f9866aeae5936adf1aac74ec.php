...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Select2::class, ['id' => 'activity_kind_id','name' => 'activity_kind_id[]','required' => true,'title' => 'Соответствие профилю','placeholder' => 'Выбор профиля','event' => 'setActivityKindId','multiple' => true,'value' => ''.e(is_array(request()->activity_kind_id) ? implode(',', request()->activity_kind_id) : '').'','url' => ''.e(route('orgunits.activity_kinds.view')).'','selectedUrl' => '/orgunits/activity_kinds']); ?>
...
<div class="row align-items-start col-md-12">
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('filters.school-and-class-multiple', ['classes' => 'row no-gutters col-md-8 my-3','schoolClasses' => 'col-md-6 mt-md-0 pr-md-4 pr-0','classClasses' => 'col-md-6 mt-6 mt-md-0 pl-md-4 pl-0'])->html();
} elseif ($_instance->childHasBeenRendered('8NmRPS6')) {
    $componentId = $_instance->getRenderedChildComponentId('8NmRPS6');
    $componentTag = $_instance->getRenderedChildComponentTagName('8NmRPS6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8NmRPS6');
} else {
    $response = \Livewire\Livewire::mount('filters.school-and-class-multiple', ['classes' => 'row no-gutters col-md-8 my-3','schoolClasses' => 'col-md-6 mt-md-0 pr-md-4 pr-0','classClasses' => 'col-md-6 mt-6 mt-md-0 pl-md-4 pl-0']);
    $html = $response->html();
    $_instance->logRenderedChild('8NmRPS6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
...
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/employer/reports/_students/search.blade.php ENDPATH**/ ?>