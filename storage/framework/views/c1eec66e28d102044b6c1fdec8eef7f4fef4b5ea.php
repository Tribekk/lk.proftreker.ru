...
} elseif ($_instance->childHasBeenRendered('ULsZY4T')) {
    $componentId = $_instance->getRenderedChildComponentId('ULsZY4T');
    $componentTag = $_instance->getRenderedChildComponentTagName('ULsZY4T');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ULsZY4T');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', []);
    $html = $response->html();
    $_instance->logRenderedChild('ULsZY4T', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/user/type/_student-form.blade.php ENDPATH**/ ?>