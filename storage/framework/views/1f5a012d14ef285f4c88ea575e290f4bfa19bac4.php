...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('e4tOJmK')) {
    $componentId = $_instance->getRenderedChildComponentId('e4tOJmK');
    $componentTag = $_instance->getRenderedChildComponentTagName('e4tOJmK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('e4tOJmK');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('e4tOJmK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/components/tables/filter-inputs/select2.blade.php ENDPATH**/ ?>