...
} elseif ($_instance->childHasBeenRendered('liEpBpv')) {
    $componentId = $_instance->getRenderedChildComponentId('liEpBpv');
    $componentTag = $_instance->getRenderedChildComponentTagName('liEpBpv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('liEpBpv');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('liEpBpv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
