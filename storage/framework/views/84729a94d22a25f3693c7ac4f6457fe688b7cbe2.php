...
} elseif ($_instance->childHasBeenRendered('sUrvAq9')) {
    $componentId = $_instance->getRenderedChildComponentId('sUrvAq9');
    $componentTag = $_instance->getRenderedChildComponentTagName('sUrvAq9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sUrvAq9');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('sUrvAq9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/employer/reports/students.blade.php ENDPATH**/ ?>