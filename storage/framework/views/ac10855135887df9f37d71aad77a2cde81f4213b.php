...
} elseif ($_instance->childHasBeenRendered('5ZmLByJ')) {
    $componentId = $_instance->getRenderedChildComponentId('5ZmLByJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('5ZmLByJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5ZmLByJ');
} else {
    $response = \Livewire\Livewire::mount('user.profile.unread-notifications-count', []);
    $html = $response->html();
    $_instance->logRenderedChild('5ZmLByJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </span>
...
<?php endif; ?>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/user/profile/_nav-items.blade.php ENDPATH**/ ?>