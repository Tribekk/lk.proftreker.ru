<form class="form" method="POST" action="<?php echo e(route('observe.user')); ?>">
    <?php echo csrf_field(); ?>

    <?php if(session()->has('error')): ?>
         <?php if (isset($component)) { $__componentOriginald4c8f106e1e33ab85c5d037c2504e2574c1b0975 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Alert::class, ['type' => 'danger','text' => ''.e(session('error')).'']); ?>
...
<?php endif; ?> 
     ...
     <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['name' => 'code','title' => 'Код подтверждения','required' => true]); ?>
<?php $component->withName('inputs.input-text-v'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/user/observe/_observe-child-form.blade.php ENDPATH**/ ?>