...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('Nac8Pk8')) {
    $componentId = $_instance->getRenderedChildComponentId('Nac8Pk8');
    $componentTag = $_instance->getRenderedChildComponentTagName('Nac8Pk8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Nac8Pk8');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('Nac8Pk8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
