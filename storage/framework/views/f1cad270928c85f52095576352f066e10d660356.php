...
} elseif ($_instance->childHasBeenRendered('95rQFBU')) {
    $componentId = $_instance->getRenderedChildComponentId('95rQFBU');
    $componentTag = $_instance->getRenderedChildComponentTagName('95rQFBU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('95rQFBU');
} else {
    $response = \Livewire\Livewire::mount('user.notification', ['notification' => $notification]);
    $html = $response->html();
    $_instance->logRenderedChild('95rQFBU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/layout/partials/_header/_notifications.blade.php ENDPATH**/ ?>