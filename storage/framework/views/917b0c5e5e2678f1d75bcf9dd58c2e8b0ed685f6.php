...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('qg3yNxz')) {
    $componentId = $_instance->getRenderedChildComponentId('qg3yNxz');
    $componentTag = $_instance->getRenderedChildComponentTagName('qg3yNxz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qg3yNxz');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('qg3yNxz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/user/type/_employer-form.blade.php ENDPATH**/ ?>