...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('ugop9ir')) {
    $componentId = $_instance->getRenderedChildComponentId('ugop9ir');
    $componentTag = $_instance->getRenderedChildComponentTagName('ugop9ir');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ugop9ir');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('ugop9ir', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
