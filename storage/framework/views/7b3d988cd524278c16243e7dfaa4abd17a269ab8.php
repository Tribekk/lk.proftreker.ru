        ...
        <div class="ml-5 flex-grow-1">
            <div class="row">
                <div class="col-md-7 my-4">
                    ...
                    <p class="font-size-h6 text-dark text-break"><?php echo e($questionnaireResult->suitsMeBetter); ?></p>
                    ...
                    <div class="mt-5">
                        ...
                        <p class="font-size-h6 text-dark text-break"><?php echo e($questionnaireResult->concludingContractTargetedTraining); ?></p>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="max-w-md-400px mt-5">
                            <div class="text-dark font-weight-bold font-size-h5 text-center font-blue text-break"><?php echo e($questionnaireResult->chancesOfStayingHometown['value']); ?></div>
                            <div class="progress mb-4 bg-transparent my-3" style="position: relative; width: 100%; height: 18px">
                                <div class="progress-bar rounded-pill bg-blue" role="progressbar" style="width: <?php echo e($questionnaireResult->chancesOfStayingHometown['progress']); ?>%; z-index: 2;"></div>
                ...
                <div class="col-md-5 my-4">
                    ...
                    <div class="mt-5">
                        ...
                        <p class="font-size-h6 text-dark text-break"><?php echo e($questionnaireResult->receiveOffersFromTheEmployer); ?></p>
                    </div>

                    <div class="mt-5">
                        <h3 class="font-weight-bold text-primary font-size-h3">На текущий момент проявлена</h3>
                        <p class="font-size-h6 text-dark text-break"><?php echo e($questionnaireResult->willingness_to_choose_profession_label); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/quiz/_results/questionnaire-screen__willingness-to-choice.blade.php ENDPATH**/ ?>