<div>
    <form wire:submit.prevent="updatePassword">
        <div class="pb-13 pt-lg-0 pt-5">
            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg"><?php echo e(__('Смена пароля')); ?></h3>
        </div>
        <div class="form-group">
            <label for="current_password" class="font-size-h6 font-weight-bolder text-dark required"><?php echo e(__('Текущий пароль')); ?></label>
            <input
                wire:model="current_password"
                type="password"
                class="form-control form-control-solid h-auto py-4 px-6 rounded-lg <?php $__errorArgs = ['current_password'];
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/livewire/user/profile/password.blade.php ENDPATH**/ ?>