    ...
    <tr class="font-size-lg">
        ...
        <td>
            <div class="d-flex align-items-center min-w-225px max-w-225px">
                ...
                <div class="ml-4">
                    <a href="<?php echo e(route('admin.orgunits.edit', $orgunit)); ?>" class="font-weight-bolder link text-break">
        ...
        <td>
            <div class="d-flex align-items-center min-w-225px max-w-225px">
                <?php if($orgunit->parent): ?>
                    ...
                    <div class="ml-4">
                        <a href="<?php echo e(route('admin.orgunits.edit', $orgunit->parent)); ?>" class="font-weight-bolder link text-break">
                            <?php echo e($orgunit->parent->title); ?>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/admin/orgunits/_index/_table-body.blade.php ENDPATH**/ ?>