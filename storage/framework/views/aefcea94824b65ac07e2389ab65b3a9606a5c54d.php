...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('LaoFP2V')) {
    $componentId = $_instance->getRenderedChildComponentId('LaoFP2V');
    $componentTag = $_instance->getRenderedChildComponentTagName('LaoFP2V');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LaoFP2V');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('LaoFP2V', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>        
...
} elseif ($_instance->childHasBeenRendered('cU1Tahw')) {
    $componentId = $_instance->getRenderedChildComponentId('cU1Tahw');
    $componentTag = $_instance->getRenderedChildComponentTagName('cU1Tahw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cU1Tahw');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'type_of_educational_organization_id','id' => 'type_of_educational_organization','url' => ''.e(route('admin.types_of_educational_organization.view')).'','event' => 'setTypeEducationalOrganization','placeholder' => ''.e(__('Укажите вид образовательной организации')).'','selected' => ''.e(old('type_of_educational_organization_id', $school->type_of_educational_organization_id)).'','selectedItemUrl' => '/admin/types_of_educational_organization']);
    $html = $response->html();
    $_instance->logRenderedChild('cU1Tahw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('qP3cWLz')) {
    $componentId = $_instance->getRenderedChildComponentId('qP3cWLz');
    $componentTag = $_instance->getRenderedChildComponentTagName('qP3cWLz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qP3cWLz');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('qP3cWLz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\openserver\OpenServer\domains\prof\www\resources\views/admin/schools/_edit/_school-tab.blade.php ENDPATH**/ ?>