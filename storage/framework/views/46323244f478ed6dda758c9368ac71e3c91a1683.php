...
} elseif ($_instance->childHasBeenRendered('r0GJkWa')) {
    $componentId = $_instance->getRenderedChildComponentId('r0GJkWa');
    $componentTag = $_instance->getRenderedChildComponentTagName('r0GJkWa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('r0GJkWa');
} else {
    $response = \Livewire\Livewire::mount('employer.students.selection-results', ['row' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('r0GJkWa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/employer/reports/_students/_table-body.blade.php ENDPATH**/ ?>