...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('EqqMWG0')) {
    $componentId = $_instance->getRenderedChildComponentId('EqqMWG0');
    $componentTag = $_instance->getRenderedChildComponentTagName('EqqMWG0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EqqMWG0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('EqqMWG0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
