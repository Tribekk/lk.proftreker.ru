...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l1791350213-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1791350213-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1791350213-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1791350213-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l1791350213-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l1791350213-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1791350213-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1791350213-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1791350213-1');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e(Auth::user()->school_id).'','classId' => ''.e(Auth::user()->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('l1791350213-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/livewire/user/profile/account.blade.php ENDPATH**/ ?>