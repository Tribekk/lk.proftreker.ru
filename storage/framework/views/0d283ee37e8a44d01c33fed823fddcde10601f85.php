...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l1546837037-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1546837037-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1546837037-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1546837037-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l1546837037-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l1546837037-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1546837037-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1546837037-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1546837037-1');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e($user->school_id).'','classId' => ''.e($user->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('l1546837037-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l1546837037-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1546837037-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1546837037-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1546837037-2');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l1546837037-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/livewire/users/account.blade.php ENDPATH**/ ?>