...
} elseif ($_instance->childHasBeenRendered('HbM4Rbv')) {
    $componentId = $_instance->getRenderedChildComponentId('HbM4Rbv');
    $componentTag = $_instance->getRenderedChildComponentTagName('HbM4Rbv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HbM4Rbv');
} else {
    $response = \Livewire\Livewire::mount('user.notification', ['notification' => $notification]);
    $html = $response->html();
    $_instance->logRenderedChild('HbM4Rbv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
