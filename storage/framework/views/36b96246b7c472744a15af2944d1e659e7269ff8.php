...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l3441714828-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3441714828-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3441714828-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3441714828-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l3441714828-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3441714828-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3441714828-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3441714828-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3441714828-1');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e($user->school_id).'','classId' => ''.e($user->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('l3441714828-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l3441714828-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3441714828-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3441714828-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3441714828-2');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l3441714828-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/livewire/users/account.blade.php ENDPATH**/ ?>