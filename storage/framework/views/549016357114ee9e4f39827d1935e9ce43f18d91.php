        ...
        <div style="display: inline-block; width: 700px; float: right;">
            <div style="">
                ...
                <h4 class="font-size-h4 text-blue font-hero" style="margin-top: 25px; margin-bottom: 10px">
                    Профессии "<?php echo e($suitableProfessionMatrix->activityObject->title); ?>" + "<?php echo e($suitableProfessionMatrix->activityKind->title); ?>"
                </h4>

                <p class="font-size-h5" style="white-space: pre-line;">
                    <?php echo e($suitableProfessionMatrix->description); ?>
                ...
                <p class="font-size-h5" style="white-space: pre-line;">
                    <?php echo $suitableProfessionMatrix->professions; ?>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/quiz/_results/_pdf/test-screen__suitable-professions.blade.php ENDPATH**/ ?>