...
} elseif ($_instance->childHasBeenRendered('K2EJLTz')) {
    $componentId = $_instance->getRenderedChildComponentId('K2EJLTz');
    $componentTag = $_instance->getRenderedChildComponentTagName('K2EJLTz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('K2EJLTz');
} else {
    $response = \Livewire\Livewire::mount('feedback.mark-emotions', ['id' => 'emotion','name' => 'emotion','value' => ''.e(old('emotion')).'']);
    $html = $response->html();
    $_instance->logRenderedChild('K2EJLTz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/feedback/form.blade.php ENDPATH**/ ?>