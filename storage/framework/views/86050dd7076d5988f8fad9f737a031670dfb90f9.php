...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('69UNghR')) {
    $componentId = $_instance->getRenderedChildComponentId('69UNghR');
    $componentTag = $_instance->getRenderedChildComponentTagName('69UNghR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('69UNghR');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('69UNghR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('gUYsBSe')) {
    $componentId = $_instance->getRenderedChildComponentId('gUYsBSe');
    $componentTag = $_instance->getRenderedChildComponentTagName('gUYsBSe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gUYsBSe');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e(Auth::user()->school_id).'','classId' => ''.e(Auth::user()->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('gUYsBSe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
