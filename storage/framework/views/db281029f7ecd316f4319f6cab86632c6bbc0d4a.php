...
} elseif ($_instance->childHasBeenRendered('AxFsdA8')) {
    $componentId = $_instance->getRenderedChildComponentId('AxFsdA8');
    $componentTag = $_instance->getRenderedChildComponentTagName('AxFsdA8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AxFsdA8');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('AxFsdA8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/proftracker/resources/views/employer/dashboard.blade.php ENDPATH**/ ?>