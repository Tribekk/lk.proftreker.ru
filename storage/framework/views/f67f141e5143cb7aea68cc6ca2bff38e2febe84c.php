...
} elseif ($_instance->childHasBeenRendered('rviVU5n')) {
    $componentId = $_instance->getRenderedChildComponentId('rviVU5n');
    $componentTag = $_instance->getRenderedChildComponentTagName('rviVU5n');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rviVU5n');
} else {
    $response = \Livewire\Livewire::mount('user.notification', ['notification' => $notification]);
    $html = $response->html();
    $_instance->logRenderedChild('rviVU5n', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH /var/www/proftracker/resources/views/layout/partials/_header/_notifications.blade.php ENDPATH**/ ?>