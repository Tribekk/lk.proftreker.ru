            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title font-weight-bold font-size-h3 font-hero-super">
                        Редактирование критериев отбора (результаты углубленного теста) профиля "<?php echo e($userProfile->title); ?>"
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div style="width:100%" align="right">
                        <table><tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('user_profiles.consult_results',$userProfile->id)); ?>">
                    ...
                    <form action="<?php echo e(route('user_profiles.deep_test_results_update',$deepTestResults->first()->id)); ?>" method="POST" >
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background-color:#38957B">
                                                            ...
                                                            <?php echo $__env->make('admin.user_profiles.include.deep_result_inclinations_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background-color:#38957B">
                                                            <?php
                                                                $type="green"
                                                            ?>
                                                            <?php echo $__env->make('admin.user_profiles.include.deep_result_types_thinking', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background-color:#38957B">
                                                            <?php
                                                                $type="green"
                                                            ?>
                                                            <?php echo $__env->make('admin.user_profiles.include.deep_result_intellegense_levels', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background-color:#38957B">
                                                            <?php
                                                                $type="green"
                                                            ?>
                                                            <?php echo $__env->make('admin.user_profiles.include.deep_result_intellegense_levels_types', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/admin/user_profiles/deep_test_results.blade.php ENDPATH**/ ?>