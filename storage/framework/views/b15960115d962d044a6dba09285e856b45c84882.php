        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <button class="btn btn-success px-4 py-2 my-1" data-target="#classModal" data-toggle="modal" wire:click="createClass">
                    <i class="la la-plus"></i> Добавить класс
                </button>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><?php echo e($class->id ? 'Редактирование класса' : 'Новый класс'); ?></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <i aria-hidden="true" class="ki ki-close"></i>
                        </button>
                    </div>
                    <div class="modal-body">
                        <h4 class="font-weight-bold font-size-h3 text-primary">Класс</h4>
                         <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['name' => 'class.number','type' => 'number','title' => 'Номер','model' => 'class.number','required' => true]); ?>
...
<?php endif; ?> 
                         <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['name' => 'class.letter','type' => 'text','min' => '1','title' => 'Буква','model' => 'class.letter','required' => true]); ?>
<?php $component->withName('inputs.input-text-v'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?> 
                        ...
                        <div class="form-group">
                            <label for="profile_id" class="font-size-h6 font-weight-bolder text-dark required">Выберите профиль класса</label>
                            <div wire:ignore>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(!empty($classProfile) && $classProfile->arbitrary_title): ?>
                             <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['name' => 'class.arbitrary_profile_title','type' => 'text','title' => 'Профиль класса','model' => 'class.arbitrary_profile_title','required' => true]); ?>
<?php $component->withName('inputs.input-text-v'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
                    ...
                    <div class="modal-footer">
                        <div class="d-flex justify-content-between w-100">
                            ...
                            <?php if($class->id): ?>
                                ...
                                <div>
                                    <div>
                                        <a href="<?php echo e(route('school.classes.show.table', $class)); ?>" target="_blank" class="btn btn-outline-success font-weight-bold">Результаты тестирования класса</a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\openserver\OpenServer\domains\prof\www\resources\views/livewire/school/class-container.blade.php ENDPATH**/ ?>