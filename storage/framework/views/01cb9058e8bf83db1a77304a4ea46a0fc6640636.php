<div class="table-responsive" id="responsive-table">
    <table class="table lk-table">
        <?php echo $__env->make('admin.reports._attached_parents._table-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin.reports._attached_parents._table-body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </table>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/admin/reports/_attached_parents/_table.blade.php ENDPATH**/ ?>