...
<div class="mt-5">
    <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <button wire:click.prevent="$emit('remove-role', <?php echo e($role['id']); ?>)" class="btn btn-outline-primary mr-3 mb-3">
            <i class="la la-times"></i><?php echo e($role['title']); ?>

        </button>
        <input type="text" hidden name="roles[<?php echo e($loop->index); ?>][id]" value="<?php echo e($role['id']); ?>">
        <input type="text" hidden name="roles[<?php echo e($loop->index); ?>][name]" value="<?php echo e($role['name']); ?>">
...
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/admin/users/_create/_user_roles.blade.php ENDPATH**/ ?>