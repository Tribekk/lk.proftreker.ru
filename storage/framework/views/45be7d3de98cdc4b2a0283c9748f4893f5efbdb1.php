...
} elseif ($_instance->childHasBeenRendered('gKF2tIp')) {
    $componentId = $_instance->getRenderedChildComponentId('gKF2tIp');
    $componentTag = $_instance->getRenderedChildComponentTagName('gKF2tIp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gKF2tIp');
} else {
    $response = \Livewire\Livewire::mount('users.account', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('gKF2tIp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/admin/users/_edit/_user-tab.blade.php ENDPATH**/ ?>