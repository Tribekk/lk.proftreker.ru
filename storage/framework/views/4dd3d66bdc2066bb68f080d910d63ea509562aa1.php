...
<?php $component = $__env->getContainer()->make(App\View\Components\Subheader::class, ['title' => 'Мои классы']); ?>
                ...
                <div class="card-body">
                    <div class="mt-3 d-flex flex-wrap">
                        <div class="flex-grow-1">
                            <h2 class="font-size-h2 font-weight-bold text-break"><?php echo e($class->school->short_title ?? '-'); ?>. Класс <?php echo e($class->number); ?><?php echo e($class->letter); ?> (год: <?php echo e($class->year ? $class->year : 'не указан'); ?>)</h2>
                        </div>
                        <div class="w-md-325px w-100 justify-content-md-end d-flex mt-4 mt-md-0 mb-4 mb-md-0">
                            <?php if(Auth::user()->isTeacher || Auth::user()->isCurator): ?>
                                <a href="<?php echo e(route('school.classes.list')); ?>" class="btn btn-success"><i class="la la-reply"></i>К списку классов</a>
                                <a href="<?php echo e(route('school.classes.add_student_with_parent',['class' => $class->id])); ?>" class="btn btn-success"><i class="la la-reply"></i>Добавить ученика и родителя</a>
                            <?php endif; ?>
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="mt-2 row">
                                    ...
                                    <div class="col-md-4 my-4">
                                        ...
                                        <div class="text-dark-50 font-size-h5">Ученик - <b><?php echo e(optional($student->feedback)->mark ?? 'не указано'); ?></b></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <?php if($student->suitableProfessionsQuizFinished && $student->interestsQuizFinished): ?>
                                            <div class="row">
                                                <?php $__empty_2 = true; $__currentLoopData = $student->personTypes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <div class="col-md-3 font-size-h6 font-weight-bold my-4">
                                                        ...
                                                        <?php $__currentLoopData = $type->type->professions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profession): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="my-2 font-weight-normal"><?php echo $profession->title; ?></div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                    <div class="col-md-12">
...
<?php $component = $__env->getContainer()->make(App\View\Components\Alert::class, ['type' => 'info','text' => 'На данный момент у класса нет учеников','close' => false]); ?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/school/classes/show.blade.php ENDPATH**/ ?>