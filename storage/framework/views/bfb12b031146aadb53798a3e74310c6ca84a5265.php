...
} elseif ($_instance->childHasBeenRendered('yfL5tuM')) {
    $componentId = $_instance->getRenderedChildComponentId('yfL5tuM');
    $componentTag = $_instance->getRenderedChildComponentTagName('yfL5tuM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yfL5tuM');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('yfL5tuM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/employer/dashboard.blade.php ENDPATH**/ ?>