        ...
        <div class="row">
            <div class="col">
                <div class="card card-custom w-50">
                    <?php echo $__env->make('admin.authorization.roles._update._header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <div class="card-body">
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['name' => 'title','title' => ''.e(__('Название')).'','required' => true,'value' => $role->title]); ?>
...
<?php endif; ?> 
                             ...
                             <?php if (isset($component)) { $__componentOriginal6f417fce8705f24be4ffdd0013eba9d6e3da039f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['name' => 'name','title' => ''.e(__('Код')).'','required' => true,'value' => $role->name]); ?>
<?php $component->withName('inputs.input-text-v'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Select::class, ['name' => 'guard_name','title' => ''.e(__('Контекст')).'','values' => $guards,'required' => true,'currentValue' => $role->guard_name]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\TextArea::class, ['name' => 'description','title' => ''.e(__('Описание')).'','rows' => '5','value' => $role->description ?? '']); ?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/admin/authorization/roles/edit.blade.php ENDPATH**/ ?>