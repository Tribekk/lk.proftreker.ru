...
} elseif ($_instance->childHasBeenRendered('Xt2oKgH')) {
    $componentId = $_instance->getRenderedChildComponentId('Xt2oKgH');
    $componentTag = $_instance->getRenderedChildComponentTagName('Xt2oKgH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Xt2oKgH');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('Xt2oKgH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\openserver\OpenServer\domains\prof\www\resources\views/employer/reports/students.blade.php ENDPATH**/ ?>