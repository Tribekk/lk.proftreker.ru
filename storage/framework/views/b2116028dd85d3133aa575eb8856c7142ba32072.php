...
} elseif ($_instance->childHasBeenRendered('6gCR2gn')) {
    $componentId = $_instance->getRenderedChildComponentId('6gCR2gn');
    $componentTag = $_instance->getRenderedChildComponentTagName('6gCR2gn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6gCR2gn');
} else {
    $response = \Livewire\Livewire::mount('user.notification', ['notification' => $notification]);
    $html = $response->html();
    $_instance->logRenderedChild('6gCR2gn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/layout/partials/_header/_notifications.blade.php ENDPATH**/ ?>