    ...
    <tr class="font-size-lg">
        ...
        <td>
            <div class="max-w-150px min-w-100px">
                <?php echo e(optional($user->school)->short_title ?? 'школа не указана'); ?>, <?php if($user->class): ?> <?php echo e($user->class->number); ?><?php echo e($user->class->letter); ?> <?php else: ?> класс не указан <?php endif; ?>
            </div>
        </td>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/admin/reports/_students/_table-body.blade.php ENDPATH**/ ?>