...
<?php $component = $__env->getContainer()->make(App\View\Components\Subheader::class, ['title' => 'Управление направлениями']); ?>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <form action="<?php echo e(route('employer.events.directions.destroy', $direction)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                <form action="<?php echo e(route('employer.events.directions.update', $direction)); ?>" enctype="multipart/form-data" method="post">
                                    <?php echo csrf_field(); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['id' => 'title','name' => 'title','required' => true,'title' => 'Название','value' => ''.e(old('title', $direction->title)).'']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\ButtonLink::class, ['type' => 'btn-outline-success','link' => ''.e(route('employer.events.directions.view')).'','title' => ''.e(__('К списку направлений')).'']); ?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/events/directions/edit.blade.php ENDPATH**/ ?>