                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 d-md-block d-none">
                                <img src="<?php echo e(asset('img/teachers.png')); ?>" alt="Учитель" class="img-fluid">
                            </div>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/user/type/attach-teacher.blade.php ENDPATH**/ ?>