...
} elseif ($_instance->childHasBeenRendered('Pif3L0x')) {
    $componentId = $_instance->getRenderedChildComponentId('Pif3L0x');
    $componentTag = $_instance->getRenderedChildComponentTagName('Pif3L0x');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Pif3L0x');
} else {
    $response = \Livewire\Livewire::mount('event.attached-files', ['event' => $event]);
    $html = $response->html();
    $_instance->logRenderedChild('Pif3L0x', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/events/edit.blade.php ENDPATH**/ ?>