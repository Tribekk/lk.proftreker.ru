...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('JEmEWiX')) {
    $componentId = $_instance->getRenderedChildComponentId('JEmEWiX');
    $componentTag = $_instance->getRenderedChildComponentTagName('JEmEWiX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JEmEWiX');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('JEmEWiX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>        
...
} elseif ($_instance->childHasBeenRendered('x0cFj3i')) {
    $componentId = $_instance->getRenderedChildComponentId('x0cFj3i');
    $componentTag = $_instance->getRenderedChildComponentTagName('x0cFj3i');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('x0cFj3i');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'type_of_educational_organization_id','id' => 'type_of_educational_organization','url' => ''.e(route('admin.types_of_educational_organization.view')).'','event' => 'setTypeEducationalOrganization','placeholder' => ''.e(__('Укажите вид образовательной организации')).'','selected' => ''.e(old('type_of_educational_organization_id', $school->type_of_educational_organization_id)).'','selectedItemUrl' => '/admin/types_of_educational_organization']);
    $html = $response->html();
    $_instance->logRenderedChild('x0cFj3i', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('kiir1e8')) {
    $componentId = $_instance->getRenderedChildComponentId('kiir1e8');
    $componentTag = $_instance->getRenderedChildComponentTagName('kiir1e8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kiir1e8');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('kiir1e8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/admin/schools/_edit/_school-tab.blade.php ENDPATH**/ ?>