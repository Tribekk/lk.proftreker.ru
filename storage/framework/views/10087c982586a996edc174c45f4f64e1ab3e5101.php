...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('pDZ8Slq')) {
    $componentId = $_instance->getRenderedChildComponentId('pDZ8Slq');
    $componentTag = $_instance->getRenderedChildComponentTagName('pDZ8Slq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pDZ8Slq');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('pDZ8Slq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>        
...
} elseif ($_instance->childHasBeenRendered('ZvChANM')) {
    $componentId = $_instance->getRenderedChildComponentId('ZvChANM');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZvChANM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZvChANM');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'type_of_educational_organization_id','id' => 'type_of_educational_organization','url' => ''.e(route('admin.types_of_educational_organization.view')).'','event' => 'setTypeEducationalOrganization','placeholder' => ''.e(__('Укажите вид образовательной организации')).'','selected' => ''.e(old('type_of_educational_organization_id', $school->type_of_educational_organization_id)).'','selectedItemUrl' => '/admin/types_of_educational_organization']);
    $html = $response->html();
    $_instance->logRenderedChild('ZvChANM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('uOi9Rt8')) {
    $componentId = $_instance->getRenderedChildComponentId('uOi9Rt8');
    $componentTag = $_instance->getRenderedChildComponentTagName('uOi9Rt8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uOi9Rt8');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('uOi9Rt8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/admin/schools/_edit/_school-tab.blade.php ENDPATH**/ ?>