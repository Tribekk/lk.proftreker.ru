...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l1856979274-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1856979274-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1856979274-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1856979274-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l1856979274-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l1856979274-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1856979274-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1856979274-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1856979274-1');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e($user->school_id).'','classId' => ''.e($user->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('l1856979274-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l1856979274-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1856979274-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1856979274-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1856979274-2');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l1856979274-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/proftracker/resources/views/livewire/users/account.blade.php ENDPATH**/ ?>