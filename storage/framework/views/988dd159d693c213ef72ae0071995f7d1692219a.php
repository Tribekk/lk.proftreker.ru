...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('5DgFdxg')) {
    $componentId = $_instance->getRenderedChildComponentId('5DgFdxg');
    $componentTag = $_instance->getRenderedChildComponentTagName('5DgFdxg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5DgFdxg');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('5DgFdxg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
