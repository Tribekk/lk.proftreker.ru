...
} elseif ($_instance->childHasBeenRendered('hkbn4eW')) {
    $componentId = $_instance->getRenderedChildComponentId('hkbn4eW');
    $componentTag = $_instance->getRenderedChildComponentTagName('hkbn4eW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hkbn4eW');
} else {
    $response = \Livewire\Livewire::mount('employer.students.selection-results', ['row' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('hkbn4eW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
