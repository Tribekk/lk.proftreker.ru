...
} elseif ($_instance->childHasBeenRendered('b6g8ThZ')) {
    $componentId = $_instance->getRenderedChildComponentId('b6g8ThZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('b6g8ThZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('b6g8ThZ');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', []);
    $html = $response->html();
    $_instance->logRenderedChild('b6g8ThZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/user/type/_student-form.blade.php ENDPATH**/ ?>