...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('aiCcEi3')) {
    $componentId = $_instance->getRenderedChildComponentId('aiCcEi3');
    $componentTag = $_instance->getRenderedChildComponentTagName('aiCcEi3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aiCcEi3');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('aiCcEi3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>                                
...
} elseif ($_instance->childHasBeenRendered('P8bRar8')) {
    $componentId = $_instance->getRenderedChildComponentId('P8bRar8');
    $componentTag = $_instance->getRenderedChildComponentTagName('P8bRar8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('P8bRar8');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'type_of_educational_organization_id','id' => 'type_of_educational_organization','url' => ''.e(route('admin.types_of_educational_organization.view')).'','event' => 'setTypeEducationalOrganization','placeholder' => ''.e(__('Укажите вид образовательной организации')).'','selected' => ''.e(old('type_of_educational_organization_id')).'','selectedItemUrl' => '/admin/types_of_educational_organization']);
    $html = $response->html();
    $_instance->logRenderedChild('P8bRar8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('B2NX36T')) {
    $componentId = $_instance->getRenderedChildComponentId('B2NX36T');
    $componentTag = $_instance->getRenderedChildComponentTagName('B2NX36T');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('B2NX36T');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('B2NX36T', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/admin/schools/create.blade.php ENDPATH**/ ?>