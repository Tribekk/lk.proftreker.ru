...
} elseif ($_instance->childHasBeenRendered('KpRckGi')) {
    $componentId = $_instance->getRenderedChildComponentId('KpRckGi');
    $componentTag = $_instance->getRenderedChildComponentTagName('KpRckGi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KpRckGi');
} else {
    $response = \Livewire\Livewire::mount('user.notification', ['notification' => $notification]);
    $html = $response->html();
    $_instance->logRenderedChild('KpRckGi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/layout/partials/_header/_notifications.blade.php ENDPATH**/ ?>