...
} elseif ($_instance->childHasBeenRendered('FlcXhfW')) {
    $componentId = $_instance->getRenderedChildComponentId('FlcXhfW');
    $componentTag = $_instance->getRenderedChildComponentTagName('FlcXhfW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FlcXhfW');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', []);
    $html = $response->html();
    $_instance->logRenderedChild('FlcXhfW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/user/type/_student-form.blade.php ENDPATH**/ ?>