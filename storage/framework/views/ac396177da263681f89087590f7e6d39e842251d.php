                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background-color:#38957B">
                                                            ...
                                                            <select name="anketItems[<?php echo e($type); ?>][profession_ready]"  id="text_<?php echo e($anketItems->first()->id); ?>_profession_ready" name="anketItems[<?php echo e($type); ?>][profession_ready]">
                                                                <option value="3" <?php if(@$control_values[$type]['profession_ready']==3): ?> <?php echo "selected";?> <?php endif; ?>>неготовность к выбору профессии</option>
                                                                <option value="5" <?php if(@$control_values[$type]['profession_ready']==5): ?> <?php echo "selected";?> <?php endif; ?>>низкая готовность к выбору профессии</option>
                                                                <option value="7" <?php if(@$control_values[$type]['profession_ready']==7): ?> <?php echo "selected";?> <?php endif; ?>>достаточная готовность к выбору профессии</option>
                                                                <option value="10" <?php if(@$control_values[$type]['profession_ready']==10): ?> <?php echo "selected";?> <?php endif; ?>>высокая готовность к выбору профессии</option>
                                                            </select>
