...
<?php $component = $__env->getContainer()->make(App\View\Components\Subheader::class, ['title' => 'Управление аудиторией']); ?>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title font-weight-bold font-size-h3 font-hero-super">
                            <?php echo e($audience->title); ?>

                        </div>
                        <div class="card-toolbar">
                            <form action="<?php echo e(route('employer.events.audience.destroy', $audience)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                <form action="<?php echo e(route('employer.events.audience.update', $audience)); ?>" enctype="multipart/form-data" method="post">
                                    <?php echo csrf_field(); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['id' => 'title','name' => 'title','required' => true,'title' => 'Название','value' => ''.e(old('title', $audience->title)).'']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\ButtonLink::class, ['type' => 'btn-outline-success','link' => ''.e(route('employer.events.audience.view')).'','title' => ''.e(__('К списку аудиторий')).'']); ?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/events/audience/edit.blade.php ENDPATH**/ ?>