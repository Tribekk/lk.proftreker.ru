        ...
        <div class="col-xl-7 my-2">
            ...
            <div class="tab-content mt-5" id="myTabContent">
                <div class="tab-pane fade show active" id="select-roles" role="tabpanel" wire:ignore.self>
                    <?php echo $__env->make('admin.users._create._user_roles', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div class="tab-pane fade" id="select-permissions" role="tabpanel" wire:ignore.self>
                    <?php echo $__env->make('admin.users._create._user-permissions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
...
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/livewire/users/create_user_form_roles.blade.php ENDPATH**/ ?>