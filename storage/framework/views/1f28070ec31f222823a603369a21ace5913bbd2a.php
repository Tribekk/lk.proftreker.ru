...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l4137185720-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4137185720-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4137185720-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4137185720-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l4137185720-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l4137185720-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4137185720-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4137185720-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4137185720-1');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e(Auth::user()->school_id).'','classId' => ''.e(Auth::user()->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('l4137185720-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/proftracker/resources/views/livewire/user/profile/account.blade.php ENDPATH**/ ?>