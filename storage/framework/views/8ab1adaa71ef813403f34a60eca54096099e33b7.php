...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('0GpPxvl')) {
    $componentId = $_instance->getRenderedChildComponentId('0GpPxvl');
    $componentTag = $_instance->getRenderedChildComponentTagName('0GpPxvl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0GpPxvl');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('0GpPxvl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/admin/reports/_student-questionnaires/_search.blade.php ENDPATH**/ ?>