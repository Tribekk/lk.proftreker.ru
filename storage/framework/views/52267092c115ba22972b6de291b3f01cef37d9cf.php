...
} elseif ($_instance->childHasBeenRendered('MSaq933')) {
    $componentId = $_instance->getRenderedChildComponentId('MSaq933');
    $componentTag = $_instance->getRenderedChildComponentTagName('MSaq933');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MSaq933');
} else {
    $response = \Livewire\Livewire::mount('user.notification', ['notification' => $notification]);
    $html = $response->html();
    $_instance->logRenderedChild('MSaq933', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
