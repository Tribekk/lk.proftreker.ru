...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('Mv2C7V5')) {
    $componentId = $_instance->getRenderedChildComponentId('Mv2C7V5');
    $componentTag = $_instance->getRenderedChildComponentTagName('Mv2C7V5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Mv2C7V5');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('Mv2C7V5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/components/inputs/select2.blade.php ENDPATH**/ ?>