...
} elseif ($_instance->childHasBeenRendered('pwhk3uG')) {
    $componentId = $_instance->getRenderedChildComponentId('pwhk3uG');
    $componentTag = $_instance->getRenderedChildComponentTagName('pwhk3uG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pwhk3uG');
} else {
    $response = \Livewire\Livewire::mount('quiz.run-quiz', ['availableQuiz' => $availableQuiz]);
    $html = $response->html();
    $_instance->logRenderedChild('pwhk3uG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/proftracker/resources/views/quiz/show.blade.php ENDPATH**/ ?>