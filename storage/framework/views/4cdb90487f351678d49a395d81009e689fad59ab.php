...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('2n97oDY')) {
    $componentId = $_instance->getRenderedChildComponentId('2n97oDY');
    $componentTag = $_instance->getRenderedChildComponentTagName('2n97oDY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2n97oDY');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('2n97oDY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
<?php /**PATH /var/www/proftracker/resources/views/admin/reports/_student-questionnaires/_search.blade.php ENDPATH**/ ?>