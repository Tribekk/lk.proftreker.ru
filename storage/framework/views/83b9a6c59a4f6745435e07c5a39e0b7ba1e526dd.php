...
} elseif ($_instance->childHasBeenRendered('zfshWps')) {
    $componentId = $_instance->getRenderedChildComponentId('zfshWps');
    $componentTag = $_instance->getRenderedChildComponentTagName('zfshWps');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zfshWps');
} else {
    $response = \Livewire\Livewire::mount('school.class-container', ['school' => $school]);
    $html = $response->html();
    $_instance->logRenderedChild('zfshWps', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
} elseif ($_instance->childHasBeenRendered('yqBgXGe')) {
    $componentId = $_instance->getRenderedChildComponentId('yqBgXGe');
    $componentTag = $_instance->getRenderedChildComponentTagName('yqBgXGe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yqBgXGe');
} else {
    $response = \Livewire\Livewire::mount('school.card', ['school' => $school]);
    $html = $response->html();
    $_instance->logRenderedChild('yqBgXGe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/proftracker/resources/views/school/card.blade.php ENDPATH**/ ?>