...
} elseif ($_instance->childHasBeenRendered('JhM1c3d')) {
    $componentId = $_instance->getRenderedChildComponentId('JhM1c3d');
    $componentTag = $_instance->getRenderedChildComponentTagName('JhM1c3d');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JhM1c3d');
} else {
    $response = \Livewire\Livewire::mount('feedback.mark-emotions', ['id' => 'emotion','name' => 'emotion','value' => ''.e(old('emotion')).'']);
    $html = $response->html();
    $_instance->logRenderedChild('JhM1c3d', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/feedback/form.blade.php ENDPATH**/ ?>