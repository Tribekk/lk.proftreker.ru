...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('LD7NKN6')) {
    $componentId = $_instance->getRenderedChildComponentId('LD7NKN6');
    $componentTag = $_instance->getRenderedChildComponentTagName('LD7NKN6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LD7NKN6');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('LD7NKN6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
<?php /**PATH /home/c41010/proftrecker.ru/www/resources/views/admin/reports/_student-questionnaires/_search.blade.php ENDPATH**/ ?>