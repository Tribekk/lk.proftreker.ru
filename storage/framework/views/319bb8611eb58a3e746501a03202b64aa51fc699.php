...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('bGnRDXF')) {
    $componentId = $_instance->getRenderedChildComponentId('bGnRDXF');
    $componentTag = $_instance->getRenderedChildComponentTagName('bGnRDXF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bGnRDXF');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('bGnRDXF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>                                
...
} elseif ($_instance->childHasBeenRendered('sjEz4SM')) {
    $componentId = $_instance->getRenderedChildComponentId('sjEz4SM');
    $componentTag = $_instance->getRenderedChildComponentTagName('sjEz4SM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sjEz4SM');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'type_of_educational_organization_id','id' => 'type_of_educational_organization','url' => ''.e(route('admin.types_of_educational_organization.view')).'','event' => 'setTypeEducationalOrganization','placeholder' => ''.e(__('Укажите вид образовательной организации')).'','selected' => ''.e(old('type_of_educational_organization_id')).'','selectedItemUrl' => '/admin/types_of_educational_organization']);
    $html = $response->html();
    $_instance->logRenderedChild('sjEz4SM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('qs1ecSG')) {
    $componentId = $_instance->getRenderedChildComponentId('qs1ecSG');
    $componentTag = $_instance->getRenderedChildComponentTagName('qs1ecSG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qs1ecSG');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('qs1ecSG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/admin/schools/create.blade.php ENDPATH**/ ?>