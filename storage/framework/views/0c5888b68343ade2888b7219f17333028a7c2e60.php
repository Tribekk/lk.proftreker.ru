...
} elseif ($_instance->childHasBeenRendered('1UZq2v2')) {
    $componentId = $_instance->getRenderedChildComponentId('1UZq2v2');
    $componentTag = $_instance->getRenderedChildComponentTagName('1UZq2v2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1UZq2v2');
} else {
    $response = \Livewire\Livewire::mount('quiz.quiz-card', ['availableQuizId' => ''.e($availableQuiz->id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('1UZq2v2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('quiz.quiz-card', ['availableQuizId' => ''.e($availableQuiz->id).''])->html();
} elseif ($_instance->childHasBeenRendered('b8iuUZX')) {
    $componentId = $_instance->getRenderedChildComponentId('b8iuUZX');
    $componentTag = $_instance->getRenderedChildComponentTagName('b8iuUZX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('b8iuUZX');
} else {
    $response = \Livewire\Livewire::mount('quiz.quiz-card', ['availableQuizId' => ''.e($availableQuiz->id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('b8iuUZX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
