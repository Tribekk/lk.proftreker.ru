...
} elseif ($_instance->childHasBeenRendered('ZMiWdpV')) {
    $componentId = $_instance->getRenderedChildComponentId('ZMiWdpV');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZMiWdpV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZMiWdpV');
} else {
    $response = \Livewire\Livewire::mount('users.account', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('ZMiWdpV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/admin/users/_edit/_user-tab.blade.php ENDPATH**/ ?>