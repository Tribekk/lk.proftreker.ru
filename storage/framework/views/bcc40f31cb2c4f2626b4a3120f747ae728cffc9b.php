...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('DhWtD1d')) {
    $componentId = $_instance->getRenderedChildComponentId('DhWtD1d');
    $componentTag = $_instance->getRenderedChildComponentTagName('DhWtD1d');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DhWtD1d');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('DhWtD1d', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>        
...
} elseif ($_instance->childHasBeenRendered('zDagjZO')) {
    $componentId = $_instance->getRenderedChildComponentId('zDagjZO');
    $componentTag = $_instance->getRenderedChildComponentTagName('zDagjZO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zDagjZO');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'type_of_educational_organization_id','id' => 'type_of_educational_organization','url' => ''.e(route('admin.types_of_educational_organization.view')).'','event' => 'setTypeEducationalOrganization','placeholder' => ''.e(__('Укажите вид образовательной организации')).'','selected' => ''.e(old('type_of_educational_organization_id', $school->type_of_educational_organization_id)).'','selectedItemUrl' => '/admin/types_of_educational_organization']);
    $html = $response->html();
    $_instance->logRenderedChild('zDagjZO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('bXbwn5n')) {
    $componentId = $_instance->getRenderedChildComponentId('bXbwn5n');
    $componentTag = $_instance->getRenderedChildComponentTagName('bXbwn5n');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bXbwn5n');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('bXbwn5n', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/proftracker/resources/views/admin/schools/_edit/_school-tab.blade.php ENDPATH**/ ?>