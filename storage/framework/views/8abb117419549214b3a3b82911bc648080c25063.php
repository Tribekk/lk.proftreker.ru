...
} elseif ($_instance->childHasBeenRendered('olse3If')) {
    $componentId = $_instance->getRenderedChildComponentId('olse3If');
    $componentTag = $_instance->getRenderedChildComponentTagName('olse3If');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('olse3If');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['nullableClassId' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('olse3If', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('4ppbz5d')) {
    $componentId = $_instance->getRenderedChildComponentId('4ppbz5d');
    $componentTag = $_instance->getRenderedChildComponentTagName('4ppbz5d');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4ppbz5d');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('4ppbz5d', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/admin/users/_create/_user-tab.blade.php ENDPATH**/ ?>