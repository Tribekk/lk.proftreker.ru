<?php $__env->startSection('subheader'); ?>
    <x-subheader title="Профтрекер"  class="font-pixel text-uppercase text-center text-white > <?php if (isset($__componentOriginal)): ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\InputTextV::class, ['id' => 'events_attached_earlier','name' => 'events_attached_earlier','title' => '1. В каких профориентационных мероприятиях Вы участвовали ранее?','placeholder' => 'Напишите']); ?>
...
} elseif ($_instance->childHasBeenRendered('WvJeQmI')) {
    $componentId = $_instance->getRenderedChildComponentId('WvJeQmI');
    $componentTag = $_instance->getRenderedChildComponentTagName('WvJeQmI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WvJeQmI');
} else {
    $response = \Livewire\Livewire::mount('feedback.mark-emotions', ['id' => 'emotion','name' => 'emotion','value' => ''.e(old('emotion')).'']);
    $html = $response->html();
    $_instance->logRenderedChild('WvJeQmI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/feedback/form.blade.php ENDPATH**/ ?>