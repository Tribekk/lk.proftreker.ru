                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background-color:#38957B">
                                                            <?php
                                                                $type="green";
                                                                if(!is_array($control_values[$type]['profession_ready'])){
                                                            ...
                                                            <select name="anketItems[<?php echo e($type); ?>][profession_ready][]" class="green"  id="text_<?php echo e($anketItems->first()->id); ?>_profession_ready_green" multiple="multiple">
                                                                <option value="3" <?php if(in_array(3, @$control_values[$type]['profession_ready'])): ?> <?php echo "selected";?> <?php endif; ?>>неготовность к выбору профессии</option>
                                                                <option value="5" <?php if(in_array(5, @$control_values[$type]['profession_ready'])): ?> <?php echo "selected";?> <?php endif; ?>>низкая готовность к выбору профессии</option>
                                                                <option value="7" <?php if(in_array(7, @$control_values[$type]['profession_ready'])): ?> <?php echo "selected";?> <?php endif; ?>>достаточная готовность к выбору профессии</option>
                                                                <option value="10" <?php if(in_array(10, @$control_values[$type]['profession_ready'])): ?> <?php echo "selected";?> <?php endif; ?>>высокая готовность к выбору профессии</option>
                                                            </select>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/admin/user_profiles/anket_items.blade.php ENDPATH**/ ?>