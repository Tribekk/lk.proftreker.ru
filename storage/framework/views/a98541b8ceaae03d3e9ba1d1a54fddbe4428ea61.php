...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('SopE72p')) {
    $componentId = $_instance->getRenderedChildComponentId('SopE72p');
    $componentTag = $_instance->getRenderedChildComponentTagName('SopE72p');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SopE72p');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('SopE72p', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
