...
} elseif ($_instance->childHasBeenRendered('LsDysC5')) {
    $componentId = $_instance->getRenderedChildComponentId('LsDysC5');
    $componentTag = $_instance->getRenderedChildComponentTagName('LsDysC5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LsDysC5');
} else {
    $response = \Livewire\Livewire::mount('user.profile.unread-notifications-count', []);
    $html = $response->html();
    $_instance->logRenderedChild('LsDysC5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </span>
...
<?php endif; ?>
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/user/profile/_nav-items.blade.php ENDPATH**/ ?>