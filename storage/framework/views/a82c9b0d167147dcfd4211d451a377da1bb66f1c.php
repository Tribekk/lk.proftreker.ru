    ...
    <div class="w-100 border shadow-sm mb-10 font-size-h3 p-10">
        <div class="mb-5">
            ...
            <?php if($value->question->description): ?>
                <p class="text-dark-50 small font-size-h4"><?php echo e($value->question->description); ?></p>
            <?php endif; ?>
        </div>
...
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/quiz/questionnaire/questions.blade.php ENDPATH**/ ?>