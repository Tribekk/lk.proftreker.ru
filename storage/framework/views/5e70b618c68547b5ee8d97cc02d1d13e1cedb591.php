<div>
    <?php if($user->hasAnyRole(['parent', 'teacher', 'curator'])): ?>
        <div class="form-group">
            <label for="school_id" class="font-size-h6 font-weight-bolder text-dark required">Выберите школу</label>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('components.select2', ['name' => 'school_id','id' => 'school_id','url' => ''.e(route('admin.schools.view')).'','event' => 'setSchoolId','placeholder' => ''.e(__('Выберите школу')).'','selected' => ''.e($school_id).'','selectedItemUrl' => '/school'])->html();
} elseif ($_instance->childHasBeenRendered('l1920525914-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1920525914-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1920525914-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1920525914-0');
} else {
    $response = \Livewire\Livewire::mount('components.select2', ['name' => 'school_id','id' => 'school_id','url' => ''.e(route('admin.schools.view')).'','event' => 'setSchoolId','placeholder' => ''.e(__('Выберите школу')).'','selected' => ''.e($school_id).'','selectedItemUrl' => '/school']);
    $html = $response->html();
    $_instance->logRenderedChild('l1920525914-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l1920525914-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1920525914-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1920525914-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1920525914-1');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e($user->school_id).'','classId' => ''.e($user->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('l1920525914-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></livewire:school.select-school-class>
    <?php endif; ?>

    <?php if($user->hasRole('employer')): ?>
        <div class="form-group">
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l1920525914-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1920525914-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1920525914-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1920525914-2');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l1920525914-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\openserver\OpenServer\domains\prof\www\resources\views/livewire/users/account.blade.php ENDPATH**/ ?>