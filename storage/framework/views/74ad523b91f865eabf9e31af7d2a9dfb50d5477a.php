...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l3658799599-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3658799599-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3658799599-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3658799599-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l3658799599-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3658799599-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3658799599-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3658799599-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3658799599-1');
} else {
    $response = \Livewire\Livewire::mount('school.select-school-class', ['schoolId' => ''.e(Auth::user()->school_id).'','classId' => ''.e(Auth::user()->class_id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('l3658799599-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/livewire/user/profile/account.blade.php ENDPATH**/ ?>