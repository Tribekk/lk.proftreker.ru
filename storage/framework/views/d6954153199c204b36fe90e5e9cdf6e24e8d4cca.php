...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('wDJ8d7L')) {
    $componentId = $_instance->getRenderedChildComponentId('wDJ8d7L');
    $componentTag = $_instance->getRenderedChildComponentTagName('wDJ8d7L');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wDJ8d7L');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('wDJ8d7L', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('omdbJEZ')) {
    $componentId = $_instance->getRenderedChildComponentId('omdbJEZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('omdbJEZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('omdbJEZ');
} else {
    $response = \Livewire\Livewire::mount('user.attach.select-parent-sex', ['sex' => ''.e(old('sex', 1)).'']);
    $html = $response->html();
    $_instance->logRenderedChild('omdbJEZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/user/type/_parent-form.blade.php ENDPATH**/ ?>