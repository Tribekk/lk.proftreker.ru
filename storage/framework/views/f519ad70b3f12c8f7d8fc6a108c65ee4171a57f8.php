...
} elseif ($_instance->childHasBeenRendered('hjv1FLJ')) {
    $componentId = $_instance->getRenderedChildComponentId('hjv1FLJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('hjv1FLJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hjv1FLJ');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('hjv1FLJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
