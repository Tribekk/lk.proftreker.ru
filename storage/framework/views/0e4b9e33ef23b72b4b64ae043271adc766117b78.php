...
} elseif ($_instance->childHasBeenRendered('ANSBzxT')) {
    $componentId = $_instance->getRenderedChildComponentId('ANSBzxT');
    $componentTag = $_instance->getRenderedChildComponentTagName('ANSBzxT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ANSBzxT');
} else {
    $response = \Livewire\Livewire::mount('event.attached-files', ['event' => $event]);
    $html = $response->html();
    $_instance->logRenderedChild('ANSBzxT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\openserver\OpenServer\domains\prof\www\resources\views/events/edit.blade.php ENDPATH**/ ?>