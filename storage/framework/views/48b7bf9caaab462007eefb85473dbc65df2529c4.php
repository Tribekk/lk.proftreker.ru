...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Select2::class, ['id' => 'activity_kind_id','name' => 'activity_kind_id[]','required' => true,'title' => 'Соответствие профилю','placeholder' => 'Выбор профиля','event' => 'setActivityKindId','multiple' => true,'value' => ''.e(is_array(old('activity_kind_id')) ? implode(',', old('activity_kind_id')) : '').'','url' => ''.e(route('orgunits.activity_kinds.view')).'','selectedUrl' => '/orgunits/activity_kinds']); ?>
