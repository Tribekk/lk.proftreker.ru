...
<?php if(request('type') != 'matched_selection_base_step'): ?>
     <?php if (isset($component)) { $__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select::class, ['classes' => 'col-md-4','name' => 'base_selection','id' => 'base_selection','label' => 'Соответствие профилю','items' => [['title' => 'Показать все', 'value' => 'all'], ['title' => 'Соответсвует базовому портрету', 'value' => 'matched'], ['title' => 'Частично соответствует базовому портрету', 'value' => 'partially_matched'], ['title' => 'Не соответствует базовому', 'value' => 'mismatched']],'value' => ''.e(request()->base_selection).'']); ?>
<?php $component->withName('tables.filter-inputs.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?> <?php if (isset($__componentOriginalc50993156ccf2819e884fe38ba86d52a90faf26b)): ?>
...
<?php /**PATH /var/www/proftracker/resources/views/employer/reports/_students/search.blade.php ENDPATH**/ ?>