...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('3tOsSdm')) {
    $componentId = $_instance->getRenderedChildComponentId('3tOsSdm');
    $componentTag = $_instance->getRenderedChildComponentTagName('3tOsSdm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3tOsSdm');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('3tOsSdm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/proftracker/resources/views/components/inputs/select2.blade.php ENDPATH**/ ?>