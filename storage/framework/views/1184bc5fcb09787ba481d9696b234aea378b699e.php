                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                    <a href="<?php echo e(route('school.classes.show.table', ['class' => $class->id])); ?>" class="d-flex link align-items-center text-primary text-hover-danger text-hover-primary font-size-h2 font-weight-bold mr-3">
                                        <?php echo e($class->school->short_title ?? '-'); ?>. Класс <?php echo e($class->number); ?><?php echo e($class->letter); ?> (год: <?php echo e($class->year ? $class->year : 'не указан'); ?>, кол-во учащихся: <?php echo e($class->students_count ?? 'не указано'); ?>)
                                    </a>
                                </div>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Alert::class, ['type' => 'info','text' => 'На данный момент нет классов','close' => false]); ?>
...
<?php echo $__env->make('layout.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/school/classes/list.blade.php ENDPATH**/ ?>