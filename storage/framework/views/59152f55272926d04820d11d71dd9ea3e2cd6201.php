...
} elseif ($_instance->childHasBeenRendered('kBoFqG5')) {
    $componentId = $_instance->getRenderedChildComponentId('kBoFqG5');
    $componentTag = $_instance->getRenderedChildComponentTagName('kBoFqG5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kBoFqG5');
} else {
    $response = \Livewire\Livewire::mount('employer.sync-reports-data', ['label' => ''.e($latestSyncDataLabel).'']);
    $html = $response->html();
    $_instance->logRenderedChild('kBoFqG5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c41010/proftracker-new.na4u.ru/www/resources/views/employer/dashboard.blade.php ENDPATH**/ ?>