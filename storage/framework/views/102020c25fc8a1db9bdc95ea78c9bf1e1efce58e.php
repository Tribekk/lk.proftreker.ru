...
<?php $component = $__env->getContainer()->make(App\View\Components\Tables\FilterInputs\Select2::class, ['classes' => 'col-md-3','name' => 'school_id','id' => 'school_id','label' => ''.e(__('Школа')).'','placeholder' => ''.e(__('Школа')).'','event' => 'filterByRole','indexUrl' => ''.e(route('admin.schools.view')).'','showUrl' => '/admin/schools','value' => ''.e(request()->school_id).'']); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
<?php /**PATH /home/c41010/proftracker-4m3h.na4u.ru/www/resources/views/results/_parent-questionnaire/_search.blade.php ENDPATH**/ ?>