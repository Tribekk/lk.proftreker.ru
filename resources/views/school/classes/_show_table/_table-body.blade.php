...
@foreach($students as $index => $student)
    <tr>
        ...
        <td>
            <div class="font-size-h5">{{ $student->observers && count($student->observers)>0 ? 'Да' : 'Нет' }}</div>
        </td>
        ...
        <td>
            <div class="font-size-h5 text-nowrap">Ученик - <b>{{ optional($student->feedback)->mark ?? 'не указано' }}</b></div>
