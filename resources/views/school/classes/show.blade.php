    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
                ...
                <div class="card-body">
                    <div class="mt-3 d-flex flex-wrap">
                        <div class="flex-grow-1">
                            <h2 class="font-size-h2 font-weight-bold text-break">{{ $class->school->short_title ?? '-' }}. Класс {{ $class->number }}{{ $class->letter }} (год: {{ $class->year ? $class->year : 'не указан' }})</h2>
                        </div>
                        <div class="w-md-325px w-100 justify-content-md-end d-flex mt-4 mt-md-0 mb-4 mb-md-0">
                            @if(Auth::user()->isTeacher || Auth::user()->isCurator)
                                <a href="{{ route('school.classes.list') }}" class="btn btn-success"><i class="la la-reply"></i>К списку классов</a>
                                <a href="{{ route('school.classes.add_student_with_parent',['class' => $class->id]) }}" class="btn btn-success"><i class="la la-reply"></i>Добавить ученика и родителя</a>
                            @endif
            ...
            @forelse($students as $student)
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="mt-2 row">
                                    ...
                                    <div class="col-md-4 my-4">
                                        ...
                                        <div class="text-dark-50 font-size-h5">Ученик - <b>{{ optional($student->feedback)->mark ?? 'не указано' }}</b></div>
                ...
                @empty
                <x-alert type="info" text="На данный момент у класса нет учеников" :close="false"></x-alert>
            @endforelse
        </div>
    </div>
@endsection
