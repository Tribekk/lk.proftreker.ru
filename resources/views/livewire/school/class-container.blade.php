            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{ $class->id ? 'Редактирование класса' : 'Новый класс' }}</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <x-inputs.input-text-v name="class.number" type="number" title="Номер" model="class.number" :required="true"/>
                        <x-inputs.input-text-v name="class.letter" type="text" min="1" title="Буква" model="class.letter" :required="true"/>
                        <x-inputs.input-text-v name="class.students_count" type="number" step="1" min="1" max="9999" title="Количество учащихся" model="class.students_count"/>
                        ...
                        @if(!empty($classProfile) && $classProfile->arbitrary_title)
                            <x-inputs.input-text-v name="class.arbitrary_profile_title" type="text" title="Профиль класса" model="class.arbitrary_profile_title" :required="true"/>
                        @endif
                    ...
                    <div class="modal-footer">
                        <div class="d-flex justify-content-between w-100">
                            ...
                            @if($class->id)
                                ...
                                <div>
                                    <div>
                                        <a href="{{ route('school.classes.show.table', $class) }}" target="_blank" class="btn btn-outline-success font-weight-bold">Результаты тестирования класса</a>
