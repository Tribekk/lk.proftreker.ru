    ...
    <div class="row">
        <div class="col-md-8">
            <form action="{{ route('admin.schools.update', $school) }}" method="post">
                ...
                <x-inputs.input-text-v name="number" :required="true" title="Номер школы" value="{{ old('number', $school->number) }}"/>
                ...
                <div class="form-group">
                    ...
                    <livewire:components.select2
                        ...
                        placeholder="{{ __('Укажите вид образовательной организации') }}"
                ...
                <div class="form-group">
                    ...
                    <livewire:components.select2
                        ...
                        placeholder="{{ __('Укажите уровень лояльности') }}"
                ...
                <div class="d-flex">
                    ...
                    <x-inputs.button-link type="btn-outline-success" link="{{ route('admin.schools.view') }}" title="{{ __('К списку школ') }}"/>
                </div>
            </form>
        </div>
    </div>
