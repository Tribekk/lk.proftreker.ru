            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title font-weight-bold font-size-h3 font-hero-super">
                        Редактирование критериев отбора (базовый тест) профиля "{{ $userProfile->title }}"
                    </div>
                </div>
                <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#38957B">
                                                                ...
                                                                @include('admin.user_profiles.include.base_test_results_tipag_extended')
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#38957B">
                                                                ...
                                                                @include('admin.user_profiles.include.base_test_results_alt_component')
