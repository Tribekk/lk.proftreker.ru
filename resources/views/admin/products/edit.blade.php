...
<br>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            <div {{$dol=collect() }}>
                @if (  $product->scul == null ) <b>Вы выбрали все школы в этой локации <a href="{{ route('Product.edit_schul2', $product->id) }}">(изменить)</a></b><br>общее число школ: 
...
@endif 
                ...
                @else <strong>Число школ <a href="{{ route('Product.edit_schul2', $product->id) }}">(изменить)</a>:</strong> {{count(json_decode($product->scul))}}<br>
            ...
            <div {{ $dil = collect() }}>  
                ...
                <b>Вы выбрали все классы <a href="{{ route('Product.edit_class2', $product->id) }}">(изменить): </a></b><br>
                @if (  $product->scul) 
            ...
            <a href="{{ route('Product.edit_class2', $product->id) }}">(изменить):
                ...
                @else 
            <strong>Классы</strong> <a href="{{ route('Product.edit_class2', $product->id) }}">(изменить):<br> 
