                    ...
                    <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link mx-0" data-toggle="tab" href="#location-tab">
                                    ...
                                    <span class="nav-text font-size-lg">{{ __('Область поиска учеников') }}</span>
                                </a>
                            </li>
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                @for($i=1;$i<=10;$i++)
                                    ...
                                    <div id="main_div_location_{{$i}}" style="display:none">
                                     ...
                                     <x-inputs.address id="search_location_{{$i}}" city=""  name="search_location_{{$i}}" title="Область поиска учеников №{{$i}}"  required="true"/>
