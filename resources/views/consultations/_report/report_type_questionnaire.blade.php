...
<div class="mt-18 button-group">
    <a target="_blank" href="{{ route('quiz.results.student_questionnaire', $consultation->child)."?backTo=".urlencode(url()->full()."#report-tab") }}" class="btn btn-outline-success">Посмотреть анкету ученика</a>
