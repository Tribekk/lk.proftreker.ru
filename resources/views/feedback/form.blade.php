        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('feedback.store') }}" method="post" class="mt-10">
                    ...
                    <x-inputs.input-text-v id="events_attached_earlier" name="events_attached_earlier" title="1. В каких профориентационных мероприятиях Вы участвовали ранее?" placeholder="Напишите"></x-inputs.input-text-v>
