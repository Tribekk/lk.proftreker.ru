...
<div class="row align-items-start col-md-12">
    <livewire:filters.school-and-class-multiple classes="row no-gutters col-md-8 my-3"
    schoolClasses="col-md-6 mt-md-0 pr-md-4 pr-0"
    classClasses="col-md-6 mt-6 mt-md-0 pl-md-4 pl-0"/></div>
...
<x-tables.filter-inputs.select classes="col-md-4"
                               ...
                               label="Заполнена анкета ребенка"
...
@if(request('type') != 'got_consultation')
    <x-tables.filter-inputs.select classes="col-md-4"
                                   ...
                                   label="Ребенок получил консультацию"
    ...
    <x-tables.filter-inputs.select classes="col-md-4"
                                   ...
                                   label="Родитель получил консультацию"
                                   :items="[['title' => 'Показать все', 'value' => 'all'], ['title' => 'Получил', 'value' => 'carried_out'], ['title' => 'Приглашен', 'value' => 'invited'], ['title' => 'Не получил', 'value' => 'not_invited']]"
...
<x-tables.filter-inputs.select classes="col-md-4"
                               name="agree"
                               id="agree"
                               label="Согласие на целевое обучение"
