        ...
        <td>
            <div class="min-w-200px max-w-200px">
                @if($user->student_questionnaire_finished)
                    ...
                    <a target="_blank" href="{{ route('quiz.results.student_questionnaire', $user->user_id)."?backTo=".urlencode(url()->full()) }}" data-toggle="tooltip" title="Просмотр анкеты" class="btn btn-success btn-icon btn-sm ml-3"><i class="la la-eye"></i></a>
                @else
