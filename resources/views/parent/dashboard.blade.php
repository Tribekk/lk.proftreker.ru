                            ...
                            <div>
                               ...
                               <ol class="font-size-h5 px-5">
                                ...
                                @if(!Auth::user()->school_id)
                                    <x-alert type="light-info" text='Пожалуйста, укажите школу, в которой обучается Ваш ребенок<br><a href="/user/edit#school_id">Перейти в настройки профиля</a>' :close="false"></x-alert>
                                @endif
