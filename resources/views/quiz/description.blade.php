                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                ...
                                <form method="post" class="align-self-end mb-8 md-md-0" action="{{ route('quiz.start', $availableQuiz) }}">
                                    @csrf
                                    <button class="btn btn-info px-md-10 text-white py-4 px-5 font-size-h3 font-weight-bolder my-2 rounded-pill col-12">{{ $availableQuiz->quiz->type == "form" ? 'ПРОЙТИ АНКЕТУ' : 'ПРОЙТИ ТЕСТ' }}</button>
                                </form>
                            </div>
