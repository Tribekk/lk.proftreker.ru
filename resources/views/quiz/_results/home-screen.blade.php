<div class="card-body d-flex flex-column bg-cover-image position-relative">
    <div class="d-flex mb-48 flex-wrap flex-grow-1 align-content-start">
        <div class="mr-5 flex-grow-1">
            ...
            <h3 class="font-pixel font-size-h6 mt-8">Отчет по итогам <span class="text-primary">{{ $depthTestsFinished ? 'полного' : 'базового' }}</span> профориентационного
                тестирования</h3>
        </div>
    ...
    <div class="d-flex align-items-end flex-wrap">
        ...
        <div class="mt-8">
            ...
            <h4 class="font-size-h2">{{ $user->class->number }}{{ $user->class->letter }} класс</h4>
        </div>
    </div>
