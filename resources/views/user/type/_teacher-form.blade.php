<form class="form" method="POST" action="{{ route('attach.teacher') }}">
    ...
    <div class="form-group">
        ...
        <livewire:components.select2
            ...
            event="setSchool"
            placeholder="{{__('Укажите образовательную организацию')}}"
    ...
    <div class="pb-lg-0 pb-5">
        <a href="{{ route('dashboard') }}" class="btn btn-outline-primary font-weight-bolder font-size-h6 px-8 py-7 my-3 mr-3">
            {{ __('Назад') }}
        </a>

        <button type="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">
            {{ __('Проверить') }}
            <span class="d-block font-weight-normal">{{ __('Данные школы и классов') }}</span>
        </button>
    </div>
