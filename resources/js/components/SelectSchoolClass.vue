<template>
    <div>
        ...
        <div class="form-group">
            <label for="class_id" class="font-size-h6 font-weight-bolder text-dark required">Выберите класс</label>
...
export default {
    ...
    mounted() {
        this.initSelect2("#school_id", "Выберите школу", "/admin/schools");
        this.initSelect2("#class_id", "Выберите класс", "/admin/schools");
